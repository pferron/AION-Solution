...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactAddress :  IEquatable<ContactAddress>, IValidatableObject
    {
        /// <summary>
        ...
        public ContactAddress(string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string city = default(string), IdentifierModel country = default(IdentifierModel), IdentifierModel direction = default(IdentifierModel), DateTime? effectiveDate = default(DateTime?), DateTime? expirationDate = default(DateTime?), string fax = default(string), string faxCountryCode = default(string), string houseAlphaEnd = default(string), string houseAlphaStart = default(string), long? id = default(long?), string isPrimary = default(string), string levelEnd = default(string), string levelPrefix = default(string), string levelStart = default(string), string phone = default(string), string phoneCountryCode = default(string), string postalCode = default(string), string recipient = default(string), IdentifierModel state = default(IdentifierModel), IdentifierModel status = default(IdentifierModel), string streetAddress = default(string), long? streetEnd = default(long?), string streetName = default(string), string streetPrefix = default(string), long? streetStart = default(long?), IdentifierModel streetSuffix = default(IdentifierModel), IdentifierModel streetSuffixDirection = default(IdentifierModel), IdentifierModel type = default(IdentifierModel), string unitEnd = default(string), string unitStart = default(string), IdentifierModel unitType = default(IdentifierModel))
        {
        ...
        {
            return this.Equals(input as ContactAddress);
        }

        /// <summary>
        /// Returns true if ContactAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactAddress input)
        {
            if (input == null)
                return false;
