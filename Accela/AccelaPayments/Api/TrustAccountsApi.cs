...
namespace AccelaPayments.Api
{
    ...
    /// </summary>
        public interface ITrustAccountsApi : IApiAccessor
    {
        ...
        ApiResponse<ResponseTrustAccountModelArray> V4GetTrustAccountsWithHttpInfo (string contentType, string authorization, long? offset = null, long? limit = null, string fields = null, string lang = null);
        ...
        System.Threading.Tasks.Task<ResponseTrustAccountModelArray> V4GetTrustAccountsAsync (string contentType, string authorization, long? offset = null, long? limit = null, string fields = null, string lang = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ResponseTrustAccountModelArray>> V4GetTrustAccountsAsyncWithHttpInfo (string contentType, string authorization, long? offset = null, long? limit = null, string fields = null, string lang = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class TrustAccountsApi : ITrustAccountsApi
    {
        private AccelaPayments.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="TrustAccountsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public TrustAccountsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public TrustAccountsApi(AccelaPayments.Client.Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Get All Trust Accounts Gets all trust accounts. **API Endpoint**:  GET /v4/trustAccounts  **Scope**:  trustaccounts  **App Type**:  All  **Authorization Type**:  Access token  **Civic Platform version**: 7.3.3.4 
        /// </summary>
        /// <exception cref="AccelaPayments.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="contentType">Must be application/x-www-form-urlencoded.</param>
        /// <param name="authorization">Construct oAuth2 authentication token</param>
        ...
        /// <param name="lang">Language parameter to support I18N. Default language is en_US. (optional)</param>
        /// <returns>ResponseTrustAccountModelArray</returns>
        public ResponseTrustAccountModelArray V4GetTrustAccounts (string contentType, string authorization, long? offset = null, long? limit = null, string fields = null, string lang = null)
        {
             ApiResponse<ResponseTrustAccountModelArray> localVarResponse = V4GetTrustAccountsWithHttpInfo(contentType, authorization, offset, limit, fields, lang);
        ...
        /// <param name="lang">Language parameter to support I18N. Default language is en_US. (optional)</param>
        /// <returns>ApiResponse of ResponseTrustAccountModelArray</returns>
        public ApiResponse< ResponseTrustAccountModelArray > V4GetTrustAccountsWithHttpInfo (string contentType, string authorization, long? offset = null, long? limit = null, string fields = null, string lang = null)
        {
            // verify the required parameter 'contentType' is set
            if (contentType == null)
                throw new ApiException(400, "Missing required parameter 'contentType' when calling TrustAccountsApi->V4GetTrustAccounts");
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling TrustAccountsApi->V4GetTrustAccounts");

            var localVarPath = "/v4/trustAccounts";
            ...
            {
                Exception exception = ExceptionFactory("V4GetTrustAccounts", localVarResponse);
        ...
        /// <param name="lang">Language parameter to support I18N. Default language is en_US. (optional)</param>
        /// <returns>Task of ResponseTrustAccountModelArray</returns>
        public async System.Threading.Tasks.Task<ResponseTrustAccountModelArray> V4GetTrustAccountsAsync (string contentType, string authorization, long? offset = null, long? limit = null, string fields = null, string lang = null)
        {
             ApiResponse<ResponseTrustAccountModelArray> localVarResponse = await V4GetTrustAccountsAsyncWithHttpInfo(contentType, authorization, offset, limit, fields, lang);
             return localVarResponse.Data;
        ...
        /// <param name="lang">Language parameter to support I18N. Default language is en_US. (optional)</param>
        /// <returns>Task of ApiResponse (ResponseTrustAccountModelArray)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ResponseTrustAccountModelArray>> V4GetTrustAccountsAsyncWithHttpInfo (string contentType, string authorization, long? offset = null, long? limit = null, string fields = null, string lang = null)
        {
            // verify the required parameter 'contentType' is set
            if (contentType == null)
                throw new ApiException(400, "Missing required parameter 'contentType' when calling TrustAccountsApi->V4GetTrustAccounts");
