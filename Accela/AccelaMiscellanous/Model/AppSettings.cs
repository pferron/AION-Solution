...
namespace AccelaMiscellanous.Model
{
    ...
    public partial class AppSettings :  IEquatable<AppSettings>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="key">An app setting name..</param>
        /// <param name="value">An app setting value..</param>
        public AppSettings(string key = default(string), string value = default(string))
        {
            this.Key = key;
            this.Value = value;
        }
        ...
        /// An app setting name.
        /// </summary>
        /// <value>An app setting name.</value>
        [DataMember(Name="key", EmitDefaultValue=false)]
        public string Key { get; set; }

        /// <summary>
        /// An app setting value.
        /// </summary>
        /// <value>An app setting value.</value>
