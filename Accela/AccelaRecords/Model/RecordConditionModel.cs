...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordConditionModel :  IEquatable<RecordConditionModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecordConditionModel" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as RecordConditionModel);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(RecordConditionModel input)
        {
            if (input == null)
                return false;
