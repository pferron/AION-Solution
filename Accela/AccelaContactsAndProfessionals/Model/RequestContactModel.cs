...
namespace AccelaContactsAndProfessionals.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RequestContactModel :  IEquatable<RequestContactModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestContactModel" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RequestContactModel {\n");
        ...
        {
            return this.Equals(input as RequestContactModel);
        }

        /// <summary>
        /// Returns true if RequestContactModel instances are equal
        /// </summary>
        /// <param name="input">Instance of RequestContactModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequestContactModel input)
        {
            if (input == null)
                return false;
