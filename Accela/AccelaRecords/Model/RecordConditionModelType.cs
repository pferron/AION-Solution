...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordConditionModelType :  IEquatable<RecordConditionModelType>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecordConditionModelType {\n");
        ...
        {
            return this.Equals(input as RecordConditionModelType);
        }

        /// <summary>
        /// Returns true if RecordConditionModelType instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordConditionModelType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordConditionModelType input)
        {
            if (input == null)
                return false;
