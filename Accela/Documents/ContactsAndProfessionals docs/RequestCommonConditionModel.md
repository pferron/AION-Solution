# AccelaContactsAndProfessionals.Model.RequestCommonConditionModel
## Properties
...
**ContactID** | **string** | The contact ID associated with the condition. See [Get All Contacts](./api-contacts-professionals.html#operation/v4.get.contacts). | [optional] 
