...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordConditionModelGroup :  IEquatable<RecordConditionModelGroup>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecordConditionModelGroup {\n");
        ...
        {
            return this.Equals(input as RecordConditionModelGroup);
        }

        /// <summary>
        /// Returns true if RecordConditionModelGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordConditionModelGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordConditionModelGroup input)
        {
            if (input == null)
                return false;
