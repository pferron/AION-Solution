...
{
    /// <summary>
    /// The document group which allows agencies to organize the different types of documents that users might need to add to certain applications.
    /// </summary>
    [DataContract]
    public partial class DocumentModelGroup :  IEquatable<DocumentModelGroup>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DocumentModelGroup {\n");
        ...
        {
            return this.Equals(input as DocumentModelGroup);
        }

        /// <summary>
        /// Returns true if DocumentModelGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentModelGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentModelGroup input)
        {
            if (input == null)
                return false;
