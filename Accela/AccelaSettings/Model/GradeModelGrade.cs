...
namespace AccelaSettings.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GradeModelGrade :  IEquatable<GradeModelGrade>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GradeModelGrade" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public GradeModelGrade(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GradeModelGrade {\n");
        ...
        {
            return this.Equals(input as GradeModelGrade);
        }

        /// <summary>
        /// Returns true if GradeModelGrade instances are equal
        /// </summary>
        /// <param name="input">Instance of GradeModelGrade to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GradeModelGrade input)
        {
            if (input == null)
                return false;
