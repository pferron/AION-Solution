...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordAddressModelCountry :  IEquatable<RecordAddressModelCountry>, IValidatableObject
    {
        /// <summary>
        ...
        public RecordAddressModelCountry(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecordAddressModelCountry {\n");
        ...
        {
            return this.Equals(input as RecordAddressModelCountry);
        }

        /// <summary>
        /// Returns true if RecordAddressModelCountry instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordAddressModelCountry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordAddressModelCountry input)
        {
            if (input == null)
                return false;
