...
{
    public class RecordConditionModelBE
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecordConditionModelBE" /> class.
        /// </summary>
        ...
        /// <param name="additionalInformationPlainText">An unlimited text field to use if other fields are filled..</param>
        /// <param name="appliedDate">The date the standard condition was applied..</param>
        /// <param name="appliedbyDepartment">appliedbyDepartment.</param>
        /// <param name="appliedbyUser">appliedbyUser.</param>
        /// <param name="dispAdditionalInformationPlainText">An unlimited text field to use if other fields are filled..</param>
        /// <param name="displayNoticeInAgency">Indicates whether or not to display the condition notice in Accela Automation when a condition to a record or parcel is applied..</param>
        /// <param name="displayNoticeInCitizens">Indicates whether or not to display the condition notice in Accela Citizen Access when a condition to a record or parcel is applied..</param>
        /// <param name="displayNoticeInCitizensFee">Indicates whether or not to display the condition notice in Accela Citizen Access Fee Estimate page when a condition to a record or parcel is applied..</param>
        /// <param name="displayOrder">The display order of the condition in a list..</param>
        /// <param name="effectiveDate">The date when you want the condition to become effective..</param>
        ...
        /// <param name="name">The name of the standard condition..</param>
        /// <param name="priority">priority.</param>
        /// <param name="publicDisplayMessage">Text entered into this field displays in the condition notice or condition status bar for the Condition Name for the public user in Accela IVR (AIVR) and Accela Citizen Access (ACA)..</param>
        /// <param name="resAdditionalInformationPlainText">An unlimited text field to use if other fields are filled..</param>
        /// <param name="resolutionAction">he action performed in response to a condition..</param>
        ...
        public RecordConditionModelBE(RecordConditionModelActionbyDepartment actionbyDepartment = default(RecordConditionModelActionbyDepartment), RecordConditionModelActionbyUser actionbyUser = default(RecordConditionModelActionbyUser), RecordConditionModelActiveStatus activeStatus = default(RecordConditionModelActiveStatus), string additionalInformation = default(string), string additionalInformationPlainText = default(string), DateTime? appliedDate = default(DateTime?), RecordConditionModelAppliedbyDepartment appliedbyDepartment = default(RecordConditionModelAppliedbyDepartment), RecordConditionModelAppliedbyUser appliedbyUser = default(RecordConditionModelAppliedbyUser), string dispAdditionalInformationPlainText = default(string), bool? displayNoticeInAgency = default(bool?), bool? displayNoticeInCitizens = default(bool?), bool? displayNoticeInCitizensFee = default(bool?), long? displayOrder = default(long?), DateTime? effectiveDate = default(DateTime?), DateTime? expirationDate = default(DateTime?), RecordConditionModelGroup group = default(RecordConditionModelGroup), long? id = default(long?), RecordConditionModelInheritable inheritable = default(RecordConditionModelInheritable), bool? isIncludeNameInNotice = default(bool?), bool? isIncludeShortCommentsInNotice = default(bool?), string longComments = default(string), string name = default(string), RecordConditionModelPriority priority = default(RecordConditionModelPriority), string publicDisplayMessage = default(string), string resAdditionalInformationPlainText = default(string), string resolutionAction = default(string), string serviceProviderCode = default(string), RecordConditionModelSeverity severity = default(RecordConditionModelSeverity), string shortComments = default(string), RecordConditionModelStatus status = default(RecordConditionModelStatus), DateTime? statusDate = default(DateTime?), string statusType = default(string), RecordConditionModelType type = default(RecordConditionModelType))
        {
        ...
        /// </summary>
        /// <value>The date the standard condition was applied.</value>
        ...
        /// </summary>
        /// <value>Indicates whether or not to display the condition notice in Accela Automation when a condition to a record or parcel is applied.</value>
        ...
        /// </summary>
        /// <value>Indicates whether or not to display the condition notice in Accela Citizen Access when a condition to a record or parcel is applied.</value>
        ...
        /// </summary>
        /// <value>Indicates whether or not to display the condition notice in Accela Citizen Access Fee Estimate page when a condition to a record or parcel is applied.</value>
        ...
        /// </summary>
        /// <value>The display order of the condition in a list.</value>
        ...
        /// </summary>
        /// <value>The date when you want the condition to become effective.</value>
        ...
        /// </summary>
        /// <value>The name of the standard condition.</value>
        ...
        /// </summary>
        /// <value>Text entered into this field displays in the condition notice or condition status bar for the Condition Name for the public user in Accela IVR (AIVR) and Accela Citizen Access (ACA).</value>
        ...
        /// </summary>
        /// <value>he action performed in response to a condition.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecordConditionModel {\n");
        ...
        {
            return this.Equals(input as RecordConditionModelBE);
        }

        /// <summary>
        /// Returns true if RecordConditionModel instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordConditionModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordConditionModelBE input)
        {
            if (input == null)
                return false;
