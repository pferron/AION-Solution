...
namespace AccelaSettings.Model
{
    ...
    public partial class RecordTypeModel :  IEquatable<RecordTypeModel>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Indicates whether or not the field is required.</value>
        [DataMember(Name="asChildOnly", EmitDefaultValue=false)]
        public AsChildOnlyEnum? AsChildOnly { get; set; }
        /// <summary>
        ...
        /// <param name="asChildOnly">Indicates whether or not the field is required..</param>
        ...
        public RecordTypeModel(string alias = default(string), RecordTypeAssociationsModel associations = default(RecordTypeAssociationsModel), string category = default(string), bool? createable = default(bool?), bool? deletable = default(bool?), string filterName = default(string), string group = default(string), string id = default(string), AsChildOnlyEnum? asChildOnly = default(AsChildOnlyEnum?), string module = default(string), bool? readable = default(bool?), bool? searchable = default(bool?), string subType = default(string), string text = default(string), string type = default(string), bool? updatable = default(bool?), string value = default(string))
        {
            this.Alias = alias;
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AsChildOnly: ").Append(AsChildOnly).Append("\n");
        ...
        public bool Equals(RecordTypeModel input)
        {
            ...
            return 
                ...
                (
                    this.AsChildOnly == input.AsChildOnly ||
                    (this.AsChildOnly != null &&
                    this.AsChildOnly.Equals(input.AsChildOnly))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AsChildOnly != null)
                    hashCode = hashCode * 59 + this.AsChildOnly.GetHashCode();
                if (this.Module != null)
