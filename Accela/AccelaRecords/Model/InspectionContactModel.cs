...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InspectionContactModel :  IEquatable<InspectionContactModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InspectionContactModel" /> class.
        /// </summary>
        ...
        public InspectionContactModel(OwnerAddressModel address = default(OwnerAddressModel), RecordContactSimpleModelBirthCity birthCity = default(RecordContactSimpleModelBirthCity), DateTime? birthDate = default(DateTime?), RecordContactSimpleModelBirthRegion birthRegion = default(RecordContactSimpleModelBirthRegion), RecordContactSimpleModelBirthState birthState = default(RecordContactSimpleModelBirthState), string businessName = default(string), string comment = default(string), DateTime? deceasedDate = default(DateTime?), string driverLicenseNumber = default(string), RecordContactSimpleModelDriverLicenseState driverLicenseState = default(RecordContactSimpleModelDriverLicenseState), string email = default(string), string fax = default(string), string faxCountryCode = default(string), string federalEmployerId = default(string), string firstName = default(string), string fullName = default(string), RecordContactSimpleModelGender gender = default(RecordContactSimpleModelGender), string id = default(string), string individualOrOrganization = default(string), string lastName = default(string), string middleName = default(string), string organizationName = default(string), string passportNumber = default(string), string phone1 = default(string), string phone1CountryCode = default(string), string phone2 = default(string), string phone2CountryCode = default(string), string phone3 = default(string), string phone3CountryCode = default(string), string postOfficeBox = default(string), RecordContactSimpleModelPreferredChannel preferredChannel = default(RecordContactSimpleModelPreferredChannel), RecordContactSimpleModelRace race = default(RecordContactSimpleModelRace), RecordContactSimpleModelRelation relation = default(RecordContactSimpleModelRelation), RecordContactSimpleModelSalutation salutation = default(RecordContactSimpleModelSalutation), string serviceProviderCode = default(string), string socialSecurityNumber = default(string), string stateIdNumber = default(string), RecordContactSimpleModelStatus status = default(RecordContactSimpleModelStatus), string suffix = default(string), string title = default(string), string tradeName = default(string), RecordContactSimpleModelType type = default(RecordContactSimpleModelType))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InspectionContactModel {\n");
        ...
        {
            return this.Equals(input as InspectionContactModel);
        }

        /// <summary>
        /// Returns true if InspectionContactModel instances are equal
        /// </summary>
        /// <param name="input">Instance of InspectionContactModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InspectionContactModel input)
        {
            if (input == null)
                return false;
