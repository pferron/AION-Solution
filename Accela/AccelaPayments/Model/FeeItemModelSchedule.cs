...
namespace AccelaPayments.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class FeeItemModelSchedule :  IEquatable<FeeItemModelSchedule>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FeeItemModelSchedule" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public FeeItemModelSchedule(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FeeItemModelSchedule {\n");
        ...
        {
            return this.Equals(input as FeeItemModelSchedule);
        }

        /// <summary>
        /// Returns true if FeeItemModelSchedule instances are equal
        /// </summary>
        /// <param name="input">Instance of FeeItemModelSchedule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FeeItemModelSchedule input)
        {
            if (input == null)
                return false;
