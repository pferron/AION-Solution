/***********************************************************************************************************************          
* Object:       usp_select_aion_user_get_reviewers_bypropertytype          
...
* 03/18/2021    jlindsay    change name to reflect that this is only reviewers, add filtering for just reviewers  
...
* 01/10/2022	jlindsay	change NOT IN clause to indicate user id > 1 (exclude -1 and 1 users)
***********************************************************************************************************************/
ALTER PROCEDURE [AION].[usp_select_aion_user_get_reviewers_bypropertytype] @PROJECT_TYP_REF_ID INT,
