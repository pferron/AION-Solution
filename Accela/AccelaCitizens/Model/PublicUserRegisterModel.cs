...
namespace AccelaCitizens.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PublicUserRegisterModel :  IEquatable<PublicUserRegisterModel>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicUserRegisterModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublicUserRegisterModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicUserRegisterModel" /> class.
        /// </summary>
        ...
        public PublicUserRegisterModel(List<long?> associatedLicenseIds = default(List<long?>), string cellPhone = default(string), List<PeopleModel> contacts = default(List<PeopleModel>), string email = default(string), string password = default(string), List<PublicUserQuestionModel> questions = default(List<PublicUserQuestionModel>), ReceiveSMSEnum? receiveSMS = default(ReceiveSMSEnum?), RoleEnum? role = default(RoleEnum?), string servProvCode = default(string), string userName = default(string))
        {
            // to ensure "userName" is required (not null)
            if (userName == null)
            {
                throw new InvalidDataException("userName is a required property for PublicUserRegisterModel and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PublicUserRegisterModel {\n");
        ...
        {
            return this.Equals(input as PublicUserRegisterModel);
        }

        /// <summary>
        /// Returns true if PublicUserRegisterModel instances are equal
        /// </summary>
        /// <param name="input">Instance of PublicUserRegisterModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PublicUserRegisterModel input)
        {
            if (input == null)
                return false;
