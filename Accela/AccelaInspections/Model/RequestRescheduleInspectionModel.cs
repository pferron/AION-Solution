...
{
    /// <summary>
    /// RequestRescheduleInspectionModel
    /// </summary>
    [DataContract]
    public partial class RequestRescheduleInspectionModel :  IEquatable<RequestRescheduleInspectionModel>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestRescheduleInspectionModel" /> class.
        /// </summary>
        ...
        /// <param name="scheduleDate">The date when the inspection is scheduled..</param>
        ...
        /// <summary>
        /// The date when the inspection is scheduled.
        /// </summary>
        /// <value>The date when the inspection is scheduled.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RequestRescheduleInspectionModel {\n");
        ...
        {
            return this.Equals(input as RequestRescheduleInspectionModel);
        }

        /// <summary>
        /// Returns true if RequestRescheduleInspectionModel instances are equal
        /// </summary>
        /// <param name="input">Instance of RequestRescheduleInspectionModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequestRescheduleInspectionModel input)
        {
            if (input == null)
                return false;
