/***********************************************************************************************************************  
* Object:       usp_select_aion_project_audit_get_by_id  
...
***********************************************************************************************************************/
ALTER PROCEDURE AION.[usp_select_aion_project_audit_get_by_id] @identity INT
AS
BEGIN
	...
	WHERE PROJECT_AUDIT_ID = @identity
