...
namespace AccelaAddressParcelsOwners.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConditionModelActiveStatus :  IEquatable<ConditionModelActiveStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConditionModelActiveStatus" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public ConditionModelActiveStatus(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConditionModelActiveStatus {\n");
        ...
        {
            return this.Equals(input as ConditionModelActiveStatus);
        }

        /// <summary>
        /// Returns true if ConditionModelActiveStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of ConditionModelActiveStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConditionModelActiveStatus input)
        {
            if (input == null)
                return false;
