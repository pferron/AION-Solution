...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordConditionModelInheritable :  IEquatable<RecordConditionModelInheritable>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecordConditionModelInheritable {\n");
        ...
        {
            return this.Equals(input as RecordConditionModelInheritable);
        }

        /// <summary>
        /// Returns true if RecordConditionModelInheritable instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordConditionModelInheritable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordConditionModelInheritable input)
        {
            if (input == null)
                return false;
