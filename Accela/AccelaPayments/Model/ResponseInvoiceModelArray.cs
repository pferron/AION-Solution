...
namespace AccelaPayments.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ResponseInvoiceModelArray :  IEquatable<ResponseInvoiceModelArray>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseInvoiceModelArray" /> class.
        /// </summary>
        /// <param name="result">result.</param>
        /// <param name="status">The HTTP return status..</param>
        public ResponseInvoiceModelArray(List<InvoiceModel> result = default(List<InvoiceModel>), int? status = default(int?))
        {
            this.Result = result;
            this.Status = status;
        }
        ...
        public List<InvoiceModel> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseInvoiceModelArray {\n");
        ...
        {
            return this.Equals(input as ResponseInvoiceModelArray);
        }

        /// <summary>
        /// Returns true if ResponseInvoiceModelArray instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseInvoiceModelArray to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseInvoiceModelArray input)
        {
            if (input == null)
                return false;
