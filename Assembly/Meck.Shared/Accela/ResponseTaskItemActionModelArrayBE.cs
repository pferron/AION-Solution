...
{
    public partial class ResponseTaskItemActionModelArrayBE
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseTaskItemModelArray" /> class.
        /// </summary>
        /// <param name="result">result.</param>
        /// <param name="status">The HTTP return status..</param>
        public ResponseTaskItemActionModelArrayBE(List<TaskItemActionModelBE> result = default(List<TaskItemActionModelBE>),
            int? status = default(int?))
        {

            Result = new List<TaskItemActionModelBE>();
            this.Result = result;
            this.Status = status;
        }
        ...
        public List<TaskItemActionModelBE> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseTaskItemModelArray {\n");
    ...
    /// </summary>
    [DataContract]
    public partial class TaskItemActionModelBE
    {
        /// <summary>
        ...
        public TaskItemActionModelBE(
                ...
                RecordConditionModelActionbyUserBE actionbyUser = default(RecordConditionModelActionbyUserBE), string approval = default(string),
                string assignEmailDisplay = default(string), DateTime? assignedDate = default(DateTime?),
                RecordConditionModelActionbyDepartmentBE assignedToDepartment = default(RecordConditionModelActionbyDepartmentBE),
                TaskItemModelAssignedUserBE assignedUser = default(TaskItemModelAssignedUserBE),
                BillableEnum? billable = default(BillableEnum?),
                string comment = default(string), string commentDisplay = default(string), List<string> commentPublicVisible = default(List<string>),
                ...
                double? hoursSpent = default(double?), string id = default(string), double? inPossessionTime = default(double?),
                IsActiveEnum? isActive = default(IsActiveEnum?), IsCompletedEnum? isCompleted = default(IsCompletedEnum?),
                DateTime? lastModifiedDate = default(DateTime?), string nextTaskId = default(string), string overTime = default(string), string processCode = default(string),
                RecordIdModelBE recordId = default(RecordIdModelBE),
                string serviceProviderCode = default(string), DateTime? startTime = default(DateTime?),
                TaskItemModelStatusBE status = default(TaskItemModelStatusBE), DateTime? statusDate = default(DateTime?), DateTime? trackStartDate = default(DateTime?))
        ...
        //public static implicit operator TaskItemActionModelBE(TaskItemActionModelBE v)
        //{
