...
namespace AccelaInspections.Model
{
    ...
    public partial class CustomTableMetadataModel :  IEquatable<CustomTableMetadataModel>, IValidatableObject
    {
        ...
        public CustomTableMetadataModel(long? displayOrder = default(long?), List<CustomTableMetadataFields> fields = default(List<CustomTableMetadataFields>), string id = default(string), string text = default(string))
        {
        ...
        public List<CustomTableMetadataFields> Fields { get; set; }
