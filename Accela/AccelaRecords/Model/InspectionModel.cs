...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InspectionModel :  IEquatable<InspectionModel>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InspectionModel" /> class.
        /// </summary>
        ...
        public RecordAddressModel Address { get; set; }
        ...
        public SimpleRecordModel Record { get; set; }
        ...
        public RecordTypeNoAliasModel RecordType { get; set; }
        ...
        public InspectionTypeSimpleModel Type { get; set; }
        ...
        {
            return this.Equals(input as InspectionModel);
        }

        /// <summary>
        /// Returns true if InspectionModel instances are equal
        /// </summary>
        /// <param name="input">Instance of InspectionModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InspectionModel input)
        {
            if (input == null)
                return false;
