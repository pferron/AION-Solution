...
{
    /// <summary>
    /// TrustAccountRequestModel
    /// </summary>
    [DataContract]
        public partial class TrustAccountRequestModel :  IEquatable<TrustAccountRequestModel>, IValidatableObject
    {
        /// <summary>
        /// The status of the trust account.
        /// </summary>
        /// <value>The status of the trust account.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrustAccountRequestModel" /> class.
        /// </summary>
        /// <param name="account">The account ID number for the trust account..</param>
        /// <param name="acctStatus">The status of the trust account..</param>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrustAccountRequestModel {\n");
        ...
        {
            return this.Equals(input as TrustAccountRequestModel);
        }

        /// <summary>
        /// Returns true if TrustAccountRequestModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TrustAccountRequestModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrustAccountRequestModel input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AcctStatus == input.AcctStatus ||
                    (this.AcctStatus != null &&
                    this.AcctStatus.Equals(input.AcctStatus))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AcctStatus != null)
                    hashCode = hashCode * 59 + this.AcctStatus.GetHashCode();
