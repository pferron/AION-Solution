...
namespace AccelaInspections.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InspectionConditionModel :  IEquatable<InspectionConditionModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InspectionConditionModel" /> class.
        /// </summary>
        ...
        /// <param name="inspectionId">The ID of the inspection the condition is attached to..</param>
        ...
        public InspectionConditionModel(InspectionConditionModelActionbyDepartment actionbyDepartment = default(InspectionConditionModelActionbyDepartment), InspectionConditionModelActionbyUser actionbyUser = default(InspectionConditionModelActionbyUser), InspectionConditionModelActiveStatus activeStatus = default(InspectionConditionModelActiveStatus), string additionalInformation = default(string), string additionalInformationPlainText = default(string), DateTime? appliedDate = default(DateTime?), InspectionConditionModelAppliedbyDepartment appliedbyDepartment = default(InspectionConditionModelAppliedbyDepartment), InspectionConditionModelAppliedbyUser appliedbyUser = default(InspectionConditionModelAppliedbyUser), string dispAdditionalInformationPlainText = default(string), bool? displayNoticeInAgency = default(bool?), bool? displayNoticeInCitizens = default(bool?), bool? displayNoticeInCitizensFee = default(bool?), long? displayOrder = default(long?), DateTime? effectiveDate = default(DateTime?), DateTime? expirationDate = default(DateTime?), InspectionConditionModelGroup group = default(InspectionConditionModelGroup), long? id = default(long?), InspectionConditionModelInheritable inheritable = default(InspectionConditionModelInheritable), long? inspectionId = default(long?), bool? isIncludeNameInNotice = default(bool?), bool? isIncludeShortCommentsInNotice = default(bool?), string longComments = default(string), string name = default(string), InspectionConditionModelPriority priority = default(InspectionConditionModelPriority), string publicDisplayMessage = default(string), string resAdditionalInformationPlainText = default(string), string resolutionAction = default(string), string serviceProviderCode = default(string), InspectionConditionModelSeverity severity = default(InspectionConditionModelSeverity), string shortComments = default(string), InspectionConditionModelStatus status = default(InspectionConditionModelStatus), DateTime? statusDate = default(DateTime?), string statusType = default(string), InspectionConditionModelType type = default(InspectionConditionModelType))
        {
        ...
        public InspectionConditionModelActionbyDepartment ActionbyDepartment { get; set; }

        /// <summary>
        /// Gets or Sets ActionbyUser
        /// </summary>
        [DataMember(Name="actionbyUser", EmitDefaultValue=false)]
        public InspectionConditionModelActionbyUser ActionbyUser { get; set; }

        /// <summary>
        /// Gets or Sets ActiveStatus
        /// </summary>
        [DataMember(Name="activeStatus", EmitDefaultValue=false)]
        public InspectionConditionModelActiveStatus ActiveStatus { get; set; }
        ...
        public InspectionConditionModelAppliedbyDepartment AppliedbyDepartment { get; set; }

        /// <summary>
        /// Gets or Sets AppliedbyUser
        /// </summary>
        [DataMember(Name="appliedbyUser", EmitDefaultValue=false)]
        public InspectionConditionModelAppliedbyUser AppliedbyUser { get; set; }
        ...
        public InspectionConditionModelGroup Group { get; set; }
        ...
        public InspectionConditionModelInheritable Inheritable { get; set; }

        /// <summary>
        /// The ID of the inspection the condition is attached to.
        /// </summary>
        /// <value>The ID of the inspection the condition is attached to.</value>
        ...
        public InspectionConditionModelPriority Priority { get; set; }
        ...
        public InspectionConditionModelSeverity Severity { get; set; }
        ...
        public InspectionConditionModelStatus Status { get; set; }
        ...
        public InspectionConditionModelType Type { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InspectionConditionModel {\n");
        ...
        {
            return this.Equals(input as InspectionConditionModel);
        }

        /// <summary>
        /// Returns true if InspectionConditionModel instances are equal
        /// </summary>
        /// <param name="input">Instance of InspectionConditionModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InspectionConditionModel input)
        {
            if (input == null)
                return false;
