...
namespace AccelaCitizens.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PeopleModelPreferredChannel :  IEquatable<PeopleModelPreferredChannel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PeopleModelPreferredChannel" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public PeopleModelPreferredChannel(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PeopleModelPreferredChannel {\n");
        ...
        {
            return this.Equals(input as PeopleModelPreferredChannel);
        }

        /// <summary>
        /// Returns true if PeopleModelPreferredChannel instances are equal
        /// </summary>
        /// <param name="input">Instance of PeopleModelPreferredChannel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PeopleModelPreferredChannel input)
        {
            if (input == null)
                return false;
