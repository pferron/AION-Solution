...
namespace AccelaPayments.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TrustAccountRequestModelAssociations :  IEquatable<TrustAccountRequestModelAssociations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrustAccountRequestModelAssociations" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public TrustAccountRequestModelAssociations(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrustAccountRequestModelAssociations {\n");
        ...
        {
            return this.Equals(input as TrustAccountRequestModelAssociations);
        }

        /// <summary>
        /// Returns true if TrustAccountRequestModelAssociations instances are equal
        /// </summary>
        /// <param name="input">Instance of TrustAccountRequestModelAssociations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrustAccountRequestModelAssociations input)
        {
            if (input == null)
                return false;
