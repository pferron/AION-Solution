...
namespace AccelaInspections.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InspectionContactModelRace :  IEquatable<InspectionContactModelRace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InspectionContactModelRace" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public InspectionContactModelRace(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InspectionContactModelRace {\n");
        ...
        {
            return this.Equals(input as InspectionContactModelRace);
        }

        /// <summary>
        /// Returns true if InspectionContactModelRace instances are equal
        /// </summary>
        /// <param name="input">Instance of InspectionContactModelRace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InspectionContactModelRace input)
        {
            if (input == null)
                return false;
