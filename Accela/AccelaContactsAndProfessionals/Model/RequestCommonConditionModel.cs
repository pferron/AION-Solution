...
{
    /// <summary>
    /// RequestCommonConditionModel
    /// </summary>
    [DataContract]
    public partial class RequestCommonConditionModel :  IEquatable<RequestCommonConditionModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestCommonConditionModel" /> class.
        /// </summary>
        ...
        /// <param name="contactID">The contact ID associated with the condition. See [Get All Contacts](./api-contacts-professionals.html#operation/v4.get.contacts)..</param>
        ...
        public RequestCommonConditionModel(CommonConditionModelActionbyDepartment actionbyDepartment = default(CommonConditionModelActionbyDepartment), CommonConditionModelActionbyUser actionbyUser = default(CommonConditionModelActionbyUser), CommonConditionModelActiveStatus activeStatus = default(CommonConditionModelActiveStatus), string additionalInformation = default(string), string additionalInformationPlainText = default(string), DateTime? appliedDate = default(DateTime?), CommonConditionModelAppliedbyDepartment appliedbyDepartment = default(CommonConditionModelAppliedbyDepartment), CommonConditionModelAppliedbyUser appliedbyUser = default(CommonConditionModelAppliedbyUser), string contactID = default(string), string dispAdditionalInformationPlainText = default(string), bool? displayNoticeInAgency = default(bool?), bool? displayNoticeInCitizens = default(bool?), bool? displayNoticeInCitizensFee = default(bool?), DateTime? effectiveDate = default(DateTime?), DateTime? expirationDate = default(DateTime?), CommonConditionModelGroup group = default(CommonConditionModelGroup), long? id = default(long?), CommonConditionModelInheritable inheritable = default(CommonConditionModelInheritable), bool? isIncludeNameInNotice = default(bool?), bool? isIncludeShortCommentsInNotice = default(bool?), string longComments = default(string), string name = default(string), CommonConditionModelPriority priority = default(CommonConditionModelPriority), string publicDisplayMessage = default(string), string resAdditionalInformationPlainText = default(string), string resolutionAction = default(string), string serviceProviderCode = default(string), CommonConditionModelSeverity severity = default(CommonConditionModelSeverity), string shortComments = default(string), CommonConditionModelStatus status = default(CommonConditionModelStatus), DateTime? statusDate = default(DateTime?), string statusType = default(string), CommonConditionModelType type = default(CommonConditionModelType))
        {
        ...
        /// <summary>
        /// The contact ID associated with the condition. See [Get All Contacts](./api-contacts-professionals.html#operation/v4.get.contacts).
        /// </summary>
        /// <value>The contact ID associated with the condition. See [Get All Contacts](./api-contacts-professionals.html#operation/v4.get.contacts).</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RequestCommonConditionModel {\n");
        ...
        {
            return this.Equals(input as RequestCommonConditionModel);
        }

        /// <summary>
        /// Returns true if RequestCommonConditionModel instances are equal
        /// </summary>
        /// <param name="input">Instance of RequestCommonConditionModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequestCommonConditionModel input)
        {
            if (input == null)
                return false;
