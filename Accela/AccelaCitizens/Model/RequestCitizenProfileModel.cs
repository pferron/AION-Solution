...
{
    /// <summary>
    /// RequestCitizenProfileModel
    /// </summary>
    [DataContract]
    public partial class RequestCitizenProfileModel :  IEquatable<RequestCitizenProfileModel>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestCitizenProfileModel" /> class.
        /// </summary>
        ...
        /// <param name="mobilePhoneCountryCode">The citizen user&#39;s cell phone number country code.</param>
        ...
        public RequestCitizenProfileModel(string email = default(string), long? id = default(long?), string loginName = default(string), string mobilePhone = default(string), string mobilePhoneCountryCode = default(string), List<PublicUserQuestionModel> questions = default(List<PublicUserQuestionModel>), string receiveSMS = default(string), DateTime? registerDate = default(DateTime?), RoleEnum? role = default(RoleEnum?))
        {
            this.Email = email;
            this.Id = id;
        ...
        /// <summary>
        /// The citizen user&#39;s cell phone number country code
        /// </summary>
        /// <value>The citizen user&#39;s cell phone number country code</value>
        [DataMember(Name="mobilePhoneCountryCode", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RequestCitizenProfileModel {\n");
            sb.Append("  Email: ").Append(Email).Append("\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  LoginName: ").Append(LoginName).Append("\n");
            sb.Append("  MobilePhone: ").Append(MobilePhone).Append("\n");
            sb.Append("  MobilePhoneCountryCode: ").Append(MobilePhoneCountryCode).Append("\n");
        ...
        {
            return this.Equals(input as RequestCitizenProfileModel);
        }

        /// <summary>
        /// Returns true if RequestCitizenProfileModel instances are equal
        /// </summary>
        /// <param name="input">Instance of RequestCitizenProfileModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequestCitizenProfileModel input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.MobilePhoneCountryCode == input.MobilePhoneCountryCode ||
                    (this.MobilePhoneCountryCode != null &&
                    this.MobilePhoneCountryCode.Equals(input.MobilePhoneCountryCode))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MobilePhoneCountryCode != null)
                    hashCode = hashCode * 59 + this.MobilePhoneCountryCode.GetHashCode();
