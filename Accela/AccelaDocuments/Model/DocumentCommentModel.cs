...
namespace AccelaDocuments.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DocumentCommentModel :  IEquatable<DocumentCommentModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentCommentModel" /> class.
        /// </summary>
        ...
        /// <param name="id">The system id assigned by the Civic Platform server..</param>
        /// <param name="pageNumber">The document page number the comment applies to..</param>
        /// <param name="status">status.</param>
        public DocumentCommentModel(string comment = default(string), string createdBy = default(string), DateTime? createdDate = default(DateTime?), DocumentCommentModelDiscipline discipline = default(DocumentCommentModelDiscipline), long? id = default(long?), long? pageNumber = default(long?), DocumentCommentModelStatus status = default(DocumentCommentModelStatus))
        {
        ...
        /// <summary>
        /// The system id assigned by the Civic Platform server.
        /// </summary>
        /// <value>The system id assigned by the Civic Platform server.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DocumentCommentModel {\n");
        ...
        {
            return this.Equals(input as DocumentCommentModel);
        }

        /// <summary>
        /// Returns true if DocumentCommentModel instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentCommentModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentCommentModel input)
        {
            if (input == null)
                return false;
