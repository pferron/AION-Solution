...
{
    /// <summary>
    /// CompactAddressModelV4GetCivicidCitizenaccessContacts
    /// </summary>
    [DataContract]
    public partial class CompactAddressModelV4GetCivicidCitizenaccessContacts :  IEquatable<CompactAddressModelV4GetCivicidCitizenaccessContacts>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompactAddressModelV4GetCivicidCitizenaccessContacts" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompactAddressModelV4GetCivicidCitizenaccessContacts {\n");
        ...
        {
            return this.Equals(input as CompactAddressModelV4GetCivicidCitizenaccessContacts);
        }

        /// <summary>
        /// Returns true if CompactAddressModelV4GetCivicidCitizenaccessContacts instances are equal
        /// </summary>
        /// <param name="input">Instance of CompactAddressModelV4GetCivicidCitizenaccessContacts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompactAddressModelV4GetCivicidCitizenaccessContacts input)
        {
            if (input == null)
                return false;
