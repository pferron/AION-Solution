...
namespace AccelaMiscellanous.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WorkflowTaskModel :  IEquatable<WorkflowTaskModel>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkflowTaskModel" /> class.
        /// </summary>
        ...
        /// <param name="assignEmailDisplay">Indicates whether or not to display the agency employee�s email address in ACA. Public users can then click the e-mail hyperlink and send an e-mail to the agency employee. �Y� : display the email address. �N� : hide the email address..</param>
        ...
        public WorkflowTaskModel(ConditionModelActionbyDepartment actionbyDepartment = default(ConditionModelActionbyDepartment), ConditionModelActionbyUser actionbyUser = default(ConditionModelActionbyUser), string approval = default(string), string assignEmailDisplay = default(string), DateTime? assignedDate = default(DateTime?), ConditionModelActionbyDepartment assignedToDepartment = default(ConditionModelActionbyDepartment), WorkflowTaskModelAssignedUser assignedUser = default(WorkflowTaskModelAssignedUser), BillableEnum? billable = default(BillableEnum?), string comment = default(string), string commentDisplay = default(string), List<string> commentPublicVisible = default(List<string>), string currentTaskId = default(string), long? daysDue = default(long?), string description = default(string), string dispositionNote = default(string), DateTime? dueDate = default(DateTime?), DateTime? endTime = default(DateTime?), DateTime? estimatedDueDate = default(DateTime?), double? estimatedHours = default(double?), double? hoursSpent = default(double?), string id = default(string), double? inPossessionTime = default(double?), IsActiveEnum? isActive = default(IsActiveEnum?), IsCompletedEnum? isCompleted = default(IsCompletedEnum?), DateTime? lastModifiedDate = default(DateTime?), string nextTaskId = default(string), string overTime = default(string), string processCode = default(string), RecordIdModel recordId = default(RecordIdModel), string serviceProviderCode = default(string), DateTime? startTime = default(DateTime?), WorkflowTaskModelStatus status = default(WorkflowTaskModelStatus), DateTime? statusDate = default(DateTime?), DateTime? trackStartDate = default(DateTime?))
        {
        ...
        /// <summary>
        /// Indicates whether or not to display the agency employee�s email address in ACA. Public users can then click the e-mail hyperlink and send an e-mail to the agency employee. �Y� : display the email address. �N� : hide the email address.
        /// </summary>
        /// <value>Indicates whether or not to display the agency employee�s email address in ACA. Public users can then click the e-mail hyperlink and send an e-mail to the agency employee. �Y� : display the email address. �N� : hide the email address.</value>
        ...
        public ConditionModelActionbyDepartment AssignedToDepartment { get; set; }

        /// <summary>
        /// Gets or Sets AssignedUser
        /// </summary>
        [DataMember(Name="assignedUser", EmitDefaultValue=false)]
        public WorkflowTaskModelAssignedUser AssignedUser { get; set; }
        ...
        public WorkflowTaskModelStatus Status { get; set; }
        ...
        {
            return this.Equals(input as WorkflowTaskModel);
        }

        /// <summary>
        /// Returns true if WorkflowTaskModel instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkflowTaskModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkflowTaskModel input)
        {
            if (input == null)
                return false;
