...
{
    /// <summary>
    /// ResponsePaymentCommitResultModel
    /// </summary>
    [DataContract]
        public partial class ResponsePaymentCommitResultModel :  IEquatable<ResponsePaymentCommitResultModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponsePaymentCommitResultModel" /> class.
        /// </summary>
        /// <param name="result">result.</param>
        /// <param name="status">The HTTP return status..</param>
        public ResponsePaymentCommitResultModel(PaymentCommitResultModel result = default(PaymentCommitResultModel), int? status = default(int?))
        {
            this.Result = result;
            this.Status = status;
        }
        ...
        public PaymentCommitResultModel Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponsePaymentCommitResultModel {\n");
        ...
        {
            return this.Equals(input as ResponsePaymentCommitResultModel);
        }

        /// <summary>
        /// Returns true if ResponsePaymentCommitResultModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponsePaymentCommitResultModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponsePaymentCommitResultModel input)
        {
            if (input == null)
                return false;
