...
namespace AccelaCitizens.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PeopleModelRace :  IEquatable<PeopleModelRace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PeopleModelRace" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public PeopleModelRace(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PeopleModelRace {\n");
        ...
        {
            return this.Equals(input as PeopleModelRace);
        }

        /// <summary>
        /// Returns true if PeopleModelRace instances are equal
        /// </summary>
        /// <param name="input">Instance of PeopleModelRace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PeopleModelRace input)
        {
            if (input == null)
                return false;
