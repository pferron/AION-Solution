...
{
    /// <summary>
    /// ResponsePaymentResponseModel
    /// </summary>
    [DataContract]
        public partial class ResponsePaymentResponseModel :  IEquatable<ResponsePaymentResponseModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponsePaymentResponseModel" /> class.
        /// </summary>
        /// <param name="result">result.</param>
        /// <param name="status">The HTTP return status..</param>
        public ResponsePaymentResponseModel(PaymentResponseModel result = default(PaymentResponseModel), int? status = default(int?))
        {
            this.Result = result;
            this.Status = status;
        }
        ...
        public PaymentResponseModel Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponsePaymentResponseModel {\n");
        ...
        {
            return this.Equals(input as ResponsePaymentResponseModel);
        }

        /// <summary>
        /// Returns true if ResponsePaymentResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponsePaymentResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponsePaymentResponseModel input)
        {
            if (input == null)
                return false;
