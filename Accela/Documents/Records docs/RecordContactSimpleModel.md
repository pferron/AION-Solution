# AccelaRecords.Model.RecordContactSimpleModel
## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Address** | [**CompactAddressModel**](CompactAddressModel.md) |  | [optional] 
**BirthCity** | [**RecordContactSimpleModelBirthCity**](RecordContactSimpleModelBirthCity.md) |  | [optional] 
**BirthDate** | **DateTime?** | The birth date. | [optional] 
**BirthRegion** | [**RecordContactSimpleModelBirthRegion**](RecordContactSimpleModelBirthRegion.md) |  | [optional] 
**BirthState** | [**RecordContactSimpleModelBirthState**](RecordContactSimpleModelBirthState.md) |  | [optional] 
...
**DriverLicenseState** | [**RecordContactSimpleModelDriverLicenseState**](RecordContactSimpleModelDriverLicenseState.md) |  | [optional] 
**Email** | **string** | The contact&#39;s email address. | [optional] 
**EndDate** | **DateTime?** | The date when the contact address ceases to be active. | [optional] 
...
**IsPrimary** | **string** | Indicates whether or not to designate the contact as the primary contact Only one address can be primary at any given time. | [optional] 
...
**PreferredChannel** | [**RecordContactSimpleModelPreferredChannel**](RecordContactSimpleModelPreferredChannel.md) |  | [optional] 
**Race** | [**RecordContactSimpleModelRace**](RecordContactSimpleModelRace.md) |  | [optional] 
**RecordId** | [**RecordIdModel**](RecordIdModel.md) |  | [optional] 
**ReferenceContactId** | **string** | The unique Id generated for a contact stored in the sytem. | [optional] 
**Relation** | [**RecordContactSimpleModelRelation**](RecordContactSimpleModelRelation.md) |  | [optional] 
**Salutation** | [**RecordContactSimpleModelSalutation**](RecordContactSimpleModelSalutation.md) |  | [optional] 
...
**StartDate** | **DateTime?** | The date the contact became active. | [optional] 
