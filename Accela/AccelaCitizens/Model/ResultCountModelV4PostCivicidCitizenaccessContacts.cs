...
{
    /// <summary>
    /// ResultCountModelV4PostCivicidCitizenaccessContacts
    /// </summary>
    [DataContract]
    public partial class ResultCountModelV4PostCivicidCitizenaccessContacts :  IEquatable<ResultCountModelV4PostCivicidCitizenaccessContacts>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResultCountModelV4PostCivicidCitizenaccessContacts" /> class.
        /// </summary>
        ...
        public ResultCountModelV4PostCivicidCitizenaccessContacts(long? failedCount = default(long?), string failedIDs = default(string), long? successCount = default(long?), string successIDs = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResultCountModelV4PostCivicidCitizenaccessContacts {\n");
        ...
        {
            return this.Equals(input as ResultCountModelV4PostCivicidCitizenaccessContacts);
        }

        /// <summary>
        /// Returns true if ResultCountModelV4PostCivicidCitizenaccessContacts instances are equal
        /// </summary>
        /// <param name="input">Instance of ResultCountModelV4PostCivicidCitizenaccessContacts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResultCountModelV4PostCivicidCitizenaccessContacts input)
        {
            if (input == null)
                return false;
