...
namespace AccelaAddressParcelsOwners.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ParcelModelSubdivision :  IEquatable<ParcelModelSubdivision>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParcelModelSubdivision" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public ParcelModelSubdivision(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ParcelModelSubdivision {\n");
        ...
        {
            return this.Equals(input as ParcelModelSubdivision);
        }

        /// <summary>
        /// Returns true if ParcelModelSubdivision instances are equal
        /// </summary>
        /// <param name="input">Instance of ParcelModelSubdivision to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParcelModelSubdivision input)
        {
            if (input == null)
                return false;
