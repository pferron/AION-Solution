...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordConditionModelActiveStatus :  IEquatable<RecordConditionModelActiveStatus>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecordConditionModelActiveStatus {\n");
        ...
        {
            return this.Equals(input as RecordConditionModelActiveStatus);
        }

        /// <summary>
        /// Returns true if RecordConditionModelActiveStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordConditionModelActiveStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordConditionModelActiveStatus input)
        {
            if (input == null)
                return false;
