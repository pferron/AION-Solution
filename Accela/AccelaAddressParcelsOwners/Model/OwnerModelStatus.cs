...
namespace AccelaAddressParcelsOwners.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OwnerModelStatus :  IEquatable<OwnerModelStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OwnerModelStatus" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public OwnerModelStatus(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OwnerModelStatus {\n");
        ...
        {
            return this.Equals(input as OwnerModelStatus);
        }

        /// <summary>
        /// Returns true if OwnerModelStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of OwnerModelStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OwnerModelStatus input)
        {
            if (input == null)
                return false;
