...
namespace AccelaInspections.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResponseResultModelArray :  IEquatable<ResponseResultModelArray>, IValidatableObject
    {
        /// <summary>
        ...
        public ResponseResultModelArray(List<ResultModel> result = default(List<ResultModel>), int? status = default(int?))
        {
            this.Result = result;
            this.Status = status;
        }
        ...
        {
            return this.Equals(input as ResponseResultModelArray);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ResponseResultModelArray input)
        {
            if (input == null)
                return false;
