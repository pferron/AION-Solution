...
namespace AccelaCitizens.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PeopleModelType :  IEquatable<PeopleModelType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PeopleModelType" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public PeopleModelType(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PeopleModelType {\n");
        ...
        {
            return this.Equals(input as PeopleModelType);
        }

        /// <summary>
        /// Returns true if PeopleModelType instances are equal
        /// </summary>
        /// <param name="input">Instance of PeopleModelType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PeopleModelType input)
        {
            if (input == null)
                return false;
