...
namespace AccelaAssetsAndAssessments.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AssetMasterModel :  IEquatable<AssetMasterModel>, IValidatableObject
    {
        /// <summary>
        ...
        public AssetMasterModel(string assetId = default(string), string classType = default(string), AssetMasterModelComments comments = default(AssetMasterModelComments), double? currentValue = default(double?), DateTime? dateOfService = default(DateTime?), DependentFlagEnum? dependentFlag = default(DependentFlagEnum?), double? depreciationAmount = default(double?), DateTime? depreciationEndDate = default(DateTime?), DateTime? depreciationStartDate = default(DateTime?), double? depreciationValue = default(double?), AssetMasterModelDescription description = default(AssetMasterModelDescription), string endID = default(string), List<GISObjectModel> gisObjects = default(List<GISObjectModel>), long? id = default(long?), AssetMasterModelName name = default(AssetMasterModelName), string number = default(string), double? salvageValue = default(double?), string serviceProviderCode = default(string), double? size = default(double?), string sizeUnit = default(string), string startID = default(string), double? startValue = default(double?), AssetMasterModelStatus status = default(AssetMasterModelStatus), DateTime? statusDate = default(DateTime?), AssetMasterModelType type = default(AssetMasterModelType))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssetMasterModel {\n");
        ...
        {
            return this.Equals(input as AssetMasterModel);
        }

        /// <summary>
        /// Returns true if AssetMasterModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetMasterModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetMasterModel input)
        {
            if (input == null)
                return false;
