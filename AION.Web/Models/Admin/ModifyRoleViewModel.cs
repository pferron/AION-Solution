...
{
    public class ModifyRoleViewModel : PermissionViewModel
    {
        ...
        private List<SelectListItem> GetRoleSelectList()
        {
            ...
            foreach (SystemRole item in _systemRoles)
            {
                ...
                {
                    //if this is a parent role, show the Description
                    ...
                    {
                        //if this is a child role, show the created name
                        ret.Add(new SelectListItem
                        {
                            Text = item.RoleName,
                            Value = item.ID.ToString()
