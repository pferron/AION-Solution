...
namespace AccelaAddressParcelsOwners.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConditionModelActionbyUser :  IEquatable<ConditionModelActionbyUser>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConditionModelActionbyUser" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public ConditionModelActionbyUser(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConditionModelActionbyUser {\n");
        ...
        {
            return this.Equals(input as ConditionModelActionbyUser);
        }

        /// <summary>
        /// Returns true if ConditionModelActionbyUser instances are equal
        /// </summary>
        /// <param name="input">Instance of ConditionModelActionbyUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConditionModelActionbyUser input)
        {
            if (input == null)
                return false;
