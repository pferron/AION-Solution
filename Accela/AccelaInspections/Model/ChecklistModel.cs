...
namespace AccelaInspections.Model
{
    ...
    public partial class ChecklistModel :  IEquatable<ChecklistModel>, IValidatableObject
    {
        ...
        public ChecklistModel(string code = default(string), long? id = default(long?), IsRequiredEnum? isRequired = default(IsRequiredEnum?), bool? isSuccess = default(bool?), string message = default(string))
        {
            this.Code = code;
            this.Id = id;
