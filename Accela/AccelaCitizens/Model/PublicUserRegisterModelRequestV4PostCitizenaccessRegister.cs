...
{
    /// <summary>
    /// PublicUserRegisterModelRequestV4PostCitizenaccessRegister
    /// </summary>
    [DataContract]
    public partial class PublicUserRegisterModelRequestV4PostCitizenaccessRegister :  IEquatable<PublicUserRegisterModelRequestV4PostCitizenaccessRegister>, IValidatableObject
    {
        /// <summary>
        /// Defines Role
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicUserRegisterModelRequestV4PostCitizenaccessRegister" /> class.
        /// </summary>
        ...
        public PublicUserRegisterModelRequestV4PostCitizenaccessRegister(List<long?> associatedLicenseIds = default(List<long?>), string cellPhone = default(string), List<PeopleModelRequestV4PostCitizenaccessRegister> contacts = default(List<PeopleModelRequestV4PostCitizenaccessRegister>), string email = default(string), long? id = default(long?), string password = default(string), List<PublicUserQuestionModel> questions = default(List<PublicUserQuestionModel>), string receiveSMS = default(string), RoleEnum? role = default(RoleEnum?), string servProvCode = default(string), string userName = default(string))
        {
        ...
        public List<PeopleModelRequestV4PostCitizenaccessRegister> Contacts { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PublicUserRegisterModelRequestV4PostCitizenaccessRegister {\n");
        ...
        {
            return this.Equals(input as PublicUserRegisterModelRequestV4PostCitizenaccessRegister);
        }

        /// <summary>
        /// Returns true if PublicUserRegisterModelRequestV4PostCitizenaccessRegister instances are equal
        /// </summary>
        /// <param name="input">Instance of PublicUserRegisterModelRequestV4PostCitizenaccessRegister to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PublicUserRegisterModelRequestV4PostCitizenaccessRegister input)
        {
            if (input == null)
                return false;
