...
{
    /// <summary>
    /// InspectionAddressModel
    /// </summary>
    [DataContract]
    public partial class InspectionAddressModel :  IEquatable<InspectionAddressModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InspectionAddressModel" /> class.
        /// </summary>
        ...
        public InspectionAddressModel(string addressLine1 = default(string), string addressLine2 = default(string), InspectionAddressModelAddressTypeFlag addressTypeFlag = default(InspectionAddressModelAddressTypeFlag), string city = default(string), InspectionAddressModelCountry country = default(InspectionAddressModelCountry), string county = default(string), string description = default(string), InspectionAddressModelDirection direction = default(InspectionAddressModelDirection), double? distance = default(double?), string houseAlphaStart = default(string), string houseAlphaEnd = default(string), InspectionAddressModelHouseFractionStart houseFractionStart = default(InspectionAddressModelHouseFractionStart), InspectionAddressModelHouseFractionEnd houseFractionEnd = default(InspectionAddressModelHouseFractionEnd), long? id = default(long?), string inspectionDistrict = default(string), string inspectionDistrictPrefix = default(string), string isPrimary = default(string), string levelStart = default(string), string levelEnd = default(string), string levelPrefix = default(string), string neighborhood = default(string), string neighborhoodPrefix = default(string), string postalCode = default(string), RecordIdModel recordId = default(RecordIdModel), long? refAddressId = default(long?), string secondaryStreet = default(string), decimal? secondaryStreetNumber = default(decimal?), string serviceProviderCode = default(string), InspectionAddressModelState state = default(InspectionAddressModelState), InspectionAddressModelStatus status = default(InspectionAddressModelStatus), string streetAddress = default(string), decimal? streetEnd = default(decimal?), long? streetEndFrom = default(long?), long? streetEndTo = default(long?), string streetName = default(string), string streetPrefix = default(string), decimal? streetStart = default(decimal?), long? streetStartFrom = default(long?), long? streetStartTo = default(long?), InspectionAddressModelStreetSuffix streetSuffix = default(InspectionAddressModelStreetSuffix), InspectionAddressModelStreetSuffixDirection streetSuffixDirection = default(InspectionAddressModelStreetSuffixDirection), string unitStart = default(string), string unitEnd = default(string), InspectionAddressModelUnitType unitType = default(InspectionAddressModelUnitType), double? xCoordinate = default(double?), double? yCoordinate = default(double?))
        {
        ...
        public InspectionAddressModelAddressTypeFlag AddressTypeFlag { get; set; }
        ...
        public InspectionAddressModelCountry Country { get; set; }
        ...
        public InspectionAddressModelDirection Direction { get; set; }
        ...
        public InspectionAddressModelHouseFractionStart HouseFractionStart { get; set; }

        /// <summary>
        /// Gets or Sets HouseFractionEnd
        /// </summary>
        [DataMember(Name="houseFractionEnd", EmitDefaultValue=false)]
        public InspectionAddressModelHouseFractionEnd HouseFractionEnd { get; set; }
        ...
        public InspectionAddressModelState State { get; set; }

        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        [DataMember(Name="status", EmitDefaultValue=false)]
        public InspectionAddressModelStatus Status { get; set; }
        ...
        public InspectionAddressModelStreetSuffix StreetSuffix { get; set; }

        /// <summary>
        /// Gets or Sets StreetSuffixDirection
        /// </summary>
        [DataMember(Name="streetSuffixDirection", EmitDefaultValue=false)]
        public InspectionAddressModelStreetSuffixDirection StreetSuffixDirection { get; set; }
        ...
        public InspectionAddressModelUnitType UnitType { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InspectionAddressModel {\n");
        ...
        {
            return this.Equals(input as InspectionAddressModel);
        }

        /// <summary>
        /// Returns true if InspectionAddressModel instances are equal
        /// </summary>
        /// <param name="input">Instance of InspectionAddressModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InspectionAddressModel input)
        {
            if (input == null)
                return false;
