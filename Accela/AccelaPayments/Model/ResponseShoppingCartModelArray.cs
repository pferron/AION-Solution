...
{
    /// <summary>
    /// ResponseShoppingCartModelArray
    /// </summary>
    [DataContract]
        public partial class ResponseShoppingCartModelArray :  IEquatable<ResponseShoppingCartModelArray>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseShoppingCartModelArray" /> class.
        /// </summary>
        /// <param name="result">result.</param>
        /// <param name="status">The HTTP return status..</param>
        public ResponseShoppingCartModelArray(List<ShoppingCartModel> result = default(List<ShoppingCartModel>), int? status = default(int?))
        {
            this.Result = result;
            this.Status = status;
        }
        ...
        public List<ShoppingCartModel> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseShoppingCartModelArray {\n");
        ...
        {
            return this.Equals(input as ResponseShoppingCartModelArray);
        }

        /// <summary>
        /// Returns true if ResponseShoppingCartModelArray instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseShoppingCartModelArray to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseShoppingCartModelArray input)
        {
            if (input == null)
                return false;
