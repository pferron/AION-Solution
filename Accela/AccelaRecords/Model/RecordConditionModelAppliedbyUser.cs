...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordConditionModelAppliedbyUser :  IEquatable<RecordConditionModelAppliedbyUser>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecordConditionModelAppliedbyUser {\n");
        ...
        {
            return this.Equals(input as RecordConditionModelAppliedbyUser);
        }

        /// <summary>
        /// Returns true if RecordConditionModelAppliedbyUser instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordConditionModelAppliedbyUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordConditionModelAppliedbyUser input)
        {
            if (input == null)
                return false;
