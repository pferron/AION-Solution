...
{
    public static class CancelScheduledPlanReviewTrigger
    {
        ...
        [FunctionName("CancelScheduledPlanReviewTrigger")]
        ...
        public static void Run([TimerTrigger("0 00 23 * * 1-5")] TimerInfo myTimer, TraceWriter log, ExecutionContext context) //Every Weekday 11PM
        {
            ...
            logmessage = $"Timer trigger function CancelScheduledPlanReviewTrigger executed at: {DateTime.Now}";
            ...
            try
            {
                if (APIHelper.CancelScheduledPlanReview() == false)
                {
                    logmessage = "Error occurred during CancelScheduledPlanReviewTrigger - APIHelper.CancelScheduledPlanReview() = false.";
                    throw new Exception(logmessage);
                }
            }
            catch (Exception ex)
            {
                logmessage = "Error occurred during CancelScheduledPlanReviewTrigger. Check the logs for more details. ApplicationMessageGuid:" + applicationMessageGuid + ", Message: " + ex.Message + ", StackTrace: " + ex.StackTrace;
