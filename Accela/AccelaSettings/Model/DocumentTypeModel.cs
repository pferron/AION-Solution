...
namespace AccelaSettings.Model
{
    ...
    public partial class DocumentTypeModel :  IEquatable<DocumentTypeModel>, IValidatableObject
    {
        ...
        public DocumentTypeModel(List<DocumentTypeModelGroups> groups = default(List<DocumentTypeModelGroups>), string id = default(string), string text = default(string), string value = default(string))
        {
            this.Groups = groups;
            this.Id = id;
            this.Text = text;
        ...
        public List<DocumentTypeModelGroups> Groups { get; set; }
