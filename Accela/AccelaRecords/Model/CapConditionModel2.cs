...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CapConditionModel2 :  IEquatable<CapConditionModel2>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CapConditionModel2 {\n");
        ...
        {
            return this.Equals(input as CapConditionModel2);
        }

        /// <summary>
        /// Returns true if CapConditionModel2 instances are equal
        /// </summary>
        /// <param name="input">Instance of CapConditionModel2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapConditionModel2 input)
        {
            if (input == null)
                return false;
