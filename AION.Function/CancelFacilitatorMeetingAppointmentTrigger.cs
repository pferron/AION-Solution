...
{
    public static class CancelFacilitatorMeetingAppointmentTrigger
    {
        ...
        [FunctionName("CancelFacilitatorMeetingAppointmentTrigger")]
        ...
        public static void Run([TimerTrigger("0 00 23 * * 1-5")] TimerInfo myTimer, TraceWriter log, ExecutionContext context) //Every Weekday 11PM
        {
            ...
            logmessage = $"Timer trigger function CancelFacilitatorMeetingAppointmentTrigger executed at: {DateTime.Now}";
            log.Info(logmessage);
            ...
            try
            {
                if (APIHelper.CancelFacilitatorMeetingAppointment() == false)
                {
                    logmessage = "Error occurred during CancelFacilitatorMeetingAppointmentTrigger - APIHelper.CancelFacilitatorMeetingAppointment() = false.";
            ...
            {
                logmessage = "Error occurred during CancelFacilitatorMeetingAppointmentTrigger. Check the logs for more details. ApplicationMessageGuid:" + applicationMessageGuid + ", Message: " + ex.Message + ", StackTrace: " + ex.StackTrace;
