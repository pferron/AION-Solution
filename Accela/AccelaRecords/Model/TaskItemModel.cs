...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaskItemModel :  IEquatable<TaskItemModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TaskItemModel);
        }

        /// <summary>
        /// Returns true if TaskItemModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskItemModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskItemModel input)
        {
            if (input == null)
                return false;
