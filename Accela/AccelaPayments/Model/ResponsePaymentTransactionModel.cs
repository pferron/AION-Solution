...
{
    /// <summary>
    /// ResponsePaymentTransactionModel
    /// </summary>
    [DataContract]
        public partial class ResponsePaymentTransactionModel :  IEquatable<ResponsePaymentTransactionModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponsePaymentTransactionModel" /> class.
        /// </summary>
        /// <param name="result">result.</param>
        /// <param name="status">The HTTP return status..</param>
        public ResponsePaymentTransactionModel(List<PaymentTransactionModel> result = default(List<PaymentTransactionModel>), int? status = default(int?))
        {
            this.Result = result;
            this.Status = status;
        }
        ...
        public List<PaymentTransactionModel> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponsePaymentTransactionModel {\n");
        ...
        {
            return this.Equals(input as ResponsePaymentTransactionModel);
        }

        /// <summary>
        /// Returns true if ResponsePaymentTransactionModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponsePaymentTransactionModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponsePaymentTransactionModel input)
        {
            if (input == null)
                return false;
