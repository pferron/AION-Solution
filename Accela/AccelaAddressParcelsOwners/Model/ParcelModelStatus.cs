...
namespace AccelaAddressParcelsOwners.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ParcelModelStatus :  IEquatable<ParcelModelStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParcelModelStatus" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public ParcelModelStatus(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ParcelModelStatus {\n");
        ...
        {
            return this.Equals(input as ParcelModelStatus);
        }

        /// <summary>
        /// Returns true if ParcelModelStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of ParcelModelStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParcelModelStatus input)
        {
            if (input == null)
                return false;
