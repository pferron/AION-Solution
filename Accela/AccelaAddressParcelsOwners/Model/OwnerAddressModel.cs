...
namespace AccelaAddressParcelsOwners.Model
{
    ...
    public partial class OwnerAddressModel :  IEquatable<OwnerAddressModel>, IValidatableObject
    {
        ...
        public OwnerAddressModel(string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string city = default(string), OwnerAddressModelCountry country = default(OwnerAddressModelCountry), string postalCode = default(string), OwnerAddressModelCountry state = default(OwnerAddressModelCountry))
        {
        ...
        public OwnerAddressModelCountry Country { get; set; }
        ...
        public OwnerAddressModelCountry State { get; set; }
