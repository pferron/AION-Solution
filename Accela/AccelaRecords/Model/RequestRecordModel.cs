...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RequestRecordModel :  IEquatable<RequestRecordModel>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestRecordModel" /> class.
        /// </summary>
        ...
        public RecordContactModel Contact { get; set; }
        ...
        {
            return this.Equals(input as RequestRecordModel);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(RequestRecordModel input)
        {
            if (input == null)
                return false;
