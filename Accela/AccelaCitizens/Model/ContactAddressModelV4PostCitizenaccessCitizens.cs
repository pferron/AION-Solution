...
{
    /// <summary>
    /// ContactAddressModelV4PostCitizenaccessCitizens
    /// </summary>
    [DataContract]
    public partial class ContactAddressModelV4PostCitizenaccessCitizens :  IEquatable<ContactAddressModelV4PostCitizenaccessCitizens>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactAddressModelV4PostCitizenaccessCitizens" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactAddressModelV4PostCitizenaccessCitizens {\n");
        ...
        {
            return this.Equals(input as ContactAddressModelV4PostCitizenaccessCitizens);
        }

        /// <summary>
        /// Returns true if ContactAddressModelV4PostCitizenaccessCitizens instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactAddressModelV4PostCitizenaccessCitizens to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactAddressModelV4PostCitizenaccessCitizens input)
        {
            if (input == null)
                return false;
