...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordConditionModelAppliedbyDepartment :  IEquatable<RecordConditionModelAppliedbyDepartment>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecordConditionModelAppliedbyDepartment {\n");
        ...
        {
            return this.Equals(input as RecordConditionModelAppliedbyDepartment);
        }

        /// <summary>
        /// Returns true if RecordConditionModelAppliedbyDepartment instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordConditionModelAppliedbyDepartment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordConditionModelAppliedbyDepartment input)
        {
            if (input == null)
                return false;
