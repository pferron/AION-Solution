...
namespace AccelaSettings.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SettingValueModel :  IEquatable<SettingValueModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SettingValueModel" /> class.
        /// </summary>
        /// <param name="text">The setting label..</param>
        /// <param name="value">The setting value..</param>
        public SettingValueModel(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as SettingValueModel);
        }

        /// <summary>
        /// Returns true if SettingValueModel instances are equal
        /// </summary>
        /// <param name="input">Instance of SettingValueModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SettingValueModel input)
        {
            if (input == null)
                return false;
