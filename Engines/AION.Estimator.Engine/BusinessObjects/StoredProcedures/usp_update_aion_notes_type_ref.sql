...
/***********************************************************************************************************************
* Object:       usp_update_aion_notes_type_ref
* Description:  Updates NotesTypeRef record using supplied parameters.
* Parameters:   
*               @NOTES_TYP_REF_ID                                            int
*               @NOTES_TYP_REF_NM                                            varchar(100)
...
CREATE PROCEDURE [usp_update_aion_notes_type_ref]
...
AS
     ...
     DECLARE @error   int
       ...
       UPDATE NOTES_TYPE_REF
       SET
            NOTES_TYP_REF_NM                                             = @NOTES_TYP_REF_NM
     ...
     IF @error != 0
          RAISERROR('Error updating NotesTypeRef record.', 18,1)
