...
{
    /// <summary>
    /// ResultCountModelV4DeleteCivicidCitizenaccessContactsIds
    /// </summary>
    [DataContract]
    public partial class ResultCountModelV4DeleteCivicidCitizenaccessContactsIds :  IEquatable<ResultCountModelV4DeleteCivicidCitizenaccessContactsIds>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResultCountModelV4DeleteCivicidCitizenaccessContactsIds" /> class.
        /// </summary>
        ...
        public ResultCountModelV4DeleteCivicidCitizenaccessContactsIds(long? failedCount = default(long?), string failedIDs = default(string), long? successCount = default(long?), string successIDs = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResultCountModelV4DeleteCivicidCitizenaccessContactsIds {\n");
        ...
        {
            return this.Equals(input as ResultCountModelV4DeleteCivicidCitizenaccessContactsIds);
        }

        /// <summary>
        /// Returns true if ResultCountModelV4DeleteCivicidCitizenaccessContactsIds instances are equal
        /// </summary>
        /// <param name="input">Instance of ResultCountModelV4DeleteCivicidCitizenaccessContactsIds to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResultCountModelV4DeleteCivicidCitizenaccessContactsIds input)
        {
            if (input == null)
                return false;
