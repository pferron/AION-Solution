...
{
    /// <summary>
    /// ContactAddressModelResponseV4PostCitizenaccessRegister
    /// </summary>
    [DataContract]
    public partial class ContactAddressModelResponseV4PostCitizenaccessRegister :  IEquatable<ContactAddressModelResponseV4PostCitizenaccessRegister>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactAddressModelResponseV4PostCitizenaccessRegister" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactAddressModelResponseV4PostCitizenaccessRegister {\n");
        ...
        {
            return this.Equals(input as ContactAddressModelResponseV4PostCitizenaccessRegister);
        }

        /// <summary>
        /// Returns true if ContactAddressModelResponseV4PostCitizenaccessRegister instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactAddressModelResponseV4PostCitizenaccessRegister to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactAddressModelResponseV4PostCitizenaccessRegister input)
        {
            if (input == null)
                return false;
