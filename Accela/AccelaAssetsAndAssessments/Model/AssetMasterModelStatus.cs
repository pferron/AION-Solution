...
namespace AccelaAssetsAndAssessments.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AssetMasterModelStatus :  IEquatable<AssetMasterModelStatus>, IValidatableObject
    {
        /// <summary>
        ...
        public AssetMasterModelStatus(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssetMasterModelStatus {\n");
        ...
        {
            return this.Equals(input as AssetMasterModelStatus);
        }

        /// <summary>
        /// Returns true if AssetMasterModelStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetMasterModelStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetMasterModelStatus input)
        {
            if (input == null)
                return false;
