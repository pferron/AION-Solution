...
namespace AccelaAddressParcelsOwners.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SimpleRecordModelPriority :  IEquatable<SimpleRecordModelPriority>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleRecordModelPriority" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public SimpleRecordModelPriority(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SimpleRecordModelPriority {\n");
        ...
        {
            return this.Equals(input as SimpleRecordModelPriority);
        }

        /// <summary>
        /// Returns true if SimpleRecordModelPriority instances are equal
        /// </summary>
        /// <param name="input">Instance of SimpleRecordModelPriority to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimpleRecordModelPriority input)
        {
            if (input == null)
                return false;
