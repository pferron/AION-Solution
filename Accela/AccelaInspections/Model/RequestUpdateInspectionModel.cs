...
{
    /// <summary>
    /// RequestUpdateInspectionModel
    /// </summary>
    [DataContract]
    public partial class RequestUpdateInspectionModel :  IEquatable<RequestUpdateInspectionModel>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestUpdateInspectionModel" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RequestUpdateInspectionModel {\n");
        ...
        {
            return this.Equals(input as RequestUpdateInspectionModel);
        }

        /// <summary>
        /// Returns true if RequestUpdateInspectionModel instances are equal
        /// </summary>
        /// <param name="input">Instance of RequestUpdateInspectionModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequestUpdateInspectionModel input)
        {
            if (input == null)
                return false;
