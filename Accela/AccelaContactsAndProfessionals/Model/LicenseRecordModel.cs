...
namespace AccelaContactsAndProfessionals.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LicenseRecordModel :  IEquatable<LicenseRecordModel>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LicenseRecordModel" /> class.
        /// </summary>
        ...
        /// <param name="assignedToStaff">The staff member responsible for the action..</param>
        ...
        /// <param name="closedByStaff">The staff member responsible for closure..</param>
        ...
        /// <param name="completedByStaff">The staff member responsible for completion..</param>
        /// <param name="completedDate">The date the application was completed..</param>
        ...
        /// <param name="enforceOfficerId">Name of the enforcement officer..</param>
        /// <param name="enforceOfficerName">The name of the enforcement officer..</param>
        ...
        /// <param name="updateDate">The date the record was last updated..</param>
        /// <param name="value">The record value..</param>
        public LicenseRecordModel(double? actualProductionUnit = default(double?), DateTime? appearanceDate = default(DateTime?), string appearanceDayOfWeek = default(string), DateTime? assignedDate = default(DateTime?), string assignedToDepartment = default(string), string assignedToStaff = default(string), double? balance = default(double?), bool? booking = default(bool?), string closedByDepartment = default(string), string closedByStaff = default(string), DateTime? closedDate = default(DateTime?), string completedByDepartment = default(string), string completedByStaff = default(string), DateTime? completedDate = default(DateTime?), SimpleRecordModelConstructionType constructionType = default(SimpleRecordModelConstructionType), double? costPerUnit = default(double?), string createdBy = default(string), CreatedByCloningEnum? createdByCloning = default(CreatedByCloningEnum?), string customId = default(string), bool? defendantSignature = default(bool?), string description = default(string), string enforceDepartment = default(string), string enforceOfficerId = default(string), string enforceOfficerName = default(string), double? estimatedCostPerUnit = default(double?), DateTime? estimatedDueDate = default(DateTime?), double? estimatedProductionUnit = default(double?), double? estimatedTotalJobCost = default(double?), DateTime? firstIssuedDate = default(DateTime?), long? housingUnits = default(long?), string id = default(string), double? inPossessionTime = default(double?), bool? infraction = default(bool?), string initiatedProduct = default(string), string inspectorDepartment = default(string), string inspectorId = default(string), string inspectorName = default(string), double? jobValue = default(double?), bool? misdemeanor = default(bool?), string module = default(string), string name = default(string), long? numberOfBuildings = default(long?), bool? offenseWitnessed = default(bool?), DateTime? openedDate = default(DateTime?), double? overallApplicationTime = default(double?), SimpleRecordModelPriority priority = default(SimpleRecordModelPriority), bool? publicOwned = default(bool?), string recordClass = default(string), SimpleRecordModelReportedChannel reportedChannel = default(SimpleRecordModelReportedChannel), DateTime? reportedDate = default(DateTime?), SimpleRecordModelReportedType reportedType = default(SimpleRecordModelReportedType), DateTime? scheduledDate = default(DateTime?), string serviceProviderCode = default(string), SimpleRecordModelSeverity severity = default(SimpleRecordModelSeverity), string shortNotes = default(string), SimpleRecordModelStatus status = default(SimpleRecordModelStatus), DateTime? statusDate = default(DateTime?), SimpleRecordModelStatusReason statusReason = default(SimpleRecordModelStatusReason), StatusTypeEnum? statusType = default(StatusTypeEnum?), double? totalFee = default(double?), double? totalJobCost = default(double?), double? totalPay = default(double?), long? trackingId = default(long?), RecordTypeModel type = default(RecordTypeModel), double? undistributedCost = default(double?), DateTime? updateDate = default(DateTime?), string value = default(string))
        {
            ...
            this.ClosedByStaff = closedByStaff;
            ...
            this.EnforceOfficerId = enforceOfficerId;
            this.EnforceOfficerName = enforceOfficerName;
        ...
        [DataMember(Name="assignedToStaff", EmitDefaultValue=false)]
        ...
        [DataMember(Name="closedByStaff", EmitDefaultValue=false)]
        ...
        [DataMember(Name="completedByStaff", EmitDefaultValue=false)]
        ...
        [DataMember(Name="enforceOfficerId", EmitDefaultValue=false)]
        public string EnforceOfficerId { get; set; }

        /// <summary>
        /// The name of the enforcement officer.
        /// </summary>
        /// <value>The name of the enforcement officer.</value>
        [DataMember(Name="enforceOfficerName", EmitDefaultValue=false)]
        ...
        public SimpleRecordModelSeverity Severity { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LicenseRecordModel {\n");
            ...
            sb.Append("  EnforceOfficerId: ").Append(EnforceOfficerId).Append("\n");
            sb.Append("  EnforceOfficerName: ").Append(EnforceOfficerName).Append("\n");
        ...
        {
            return this.Equals(input as LicenseRecordModel);
        }

        /// <summary>
        /// Returns true if LicenseRecordModel instances are equal
        /// </summary>
        /// <param name="input">Instance of LicenseRecordModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LicenseRecordModel input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AssignedToStaff == input.AssignedToStaff ||
                    (this.AssignedToStaff != null &&
                    this.AssignedToStaff.Equals(input.AssignedToStaff))
                ) && 
                (
                ...
                (
                    this.ClosedByStaff == input.ClosedByStaff ||
                    (this.ClosedByStaff != null &&
                    this.ClosedByStaff.Equals(input.ClosedByStaff))
                ) && 
                (
                ...
                (
                    this.CompletedByStaff == input.CompletedByStaff ||
                    (this.CompletedByStaff != null &&
                    this.CompletedByStaff.Equals(input.CompletedByStaff))
                ) && 
                (
                ...
                (
                    this.EnforceOfficerId == input.EnforceOfficerId ||
                    (this.EnforceOfficerId != null &&
                    this.EnforceOfficerId.Equals(input.EnforceOfficerId))
                ) && 
                (
                    this.EnforceOfficerName == input.EnforceOfficerName ||
                    (this.EnforceOfficerName != null &&
                    this.EnforceOfficerName.Equals(input.EnforceOfficerName))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AssignedToStaff != null)
                    hashCode = hashCode * 59 + this.AssignedToStaff.GetHashCode();
                ...
                if (this.ClosedByStaff != null)
                    hashCode = hashCode * 59 + this.ClosedByStaff.GetHashCode();
                ...
                if (this.CompletedByStaff != null)
                    hashCode = hashCode * 59 + this.CompletedByStaff.GetHashCode();
                ...
                if (this.EnforceOfficerId != null)
                    hashCode = hashCode * 59 + this.EnforceOfficerId.GetHashCode();
                if (this.EnforceOfficerName != null)
                    hashCode = hashCode * 59 + this.EnforceOfficerName.GetHashCode();
