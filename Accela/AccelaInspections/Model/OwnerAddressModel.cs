...
namespace AccelaInspections.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OwnerAddressModel :  IEquatable<OwnerAddressModel>, IValidatableObject
    {
        /// <summary>
        ...
        public OwnerAddressModel(string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string city = default(string), ConditionHistoryModelActionbyDepartment country = default(ConditionHistoryModelActionbyDepartment), string postalCode = default(string), ConditionHistoryModelActionbyDepartment state = default(ConditionHistoryModelActionbyDepartment))
        {
        ...
        public ConditionHistoryModelActionbyDepartment Country { get; set; }
        ...
        public ConditionHistoryModelActionbyDepartment State { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OwnerAddressModel {\n");
        ...
        {
            return this.Equals(input as OwnerAddressModel);
        }

        /// <summary>
        /// Returns true if OwnerAddressModel instances are equal
        /// </summary>
        /// <param name="input">Instance of OwnerAddressModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OwnerAddressModel input)
        {
            if (input == null)
                return false;
