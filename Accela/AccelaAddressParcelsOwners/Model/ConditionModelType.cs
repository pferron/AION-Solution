...
namespace AccelaAddressParcelsOwners.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConditionModelType :  IEquatable<ConditionModelType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConditionModelType" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public ConditionModelType(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConditionModelType {\n");
        ...
        {
            return this.Equals(input as ConditionModelType);
        }

        /// <summary>
        /// Returns true if ConditionModelType instances are equal
        /// </summary>
        /// <param name="input">Instance of ConditionModelType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConditionModelType input)
        {
            if (input == null)
                return false;
