# AccelaInspections.Model.InspectionConditionModel
## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**ActionbyDepartment** | [**InspectionConditionModelActionbyDepartment**](InspectionConditionModelActionbyDepartment.md) |  | [optional] 
**ActionbyUser** | [**InspectionConditionModelActionbyUser**](InspectionConditionModelActionbyUser.md) |  | [optional] 
**ActiveStatus** | [**InspectionConditionModelActiveStatus**](InspectionConditionModelActiveStatus.md) |  | [optional] 
...
**AppliedbyDepartment** | [**InspectionConditionModelAppliedbyDepartment**](InspectionConditionModelAppliedbyDepartment.md) |  | [optional] 
**AppliedbyUser** | [**InspectionConditionModelAppliedbyUser**](InspectionConditionModelAppliedbyUser.md) |  | [optional] 
...
**Group** | [**InspectionConditionModelGroup**](InspectionConditionModelGroup.md) |  | [optional] 
**Id** | **long?** | The condition system id assigned by the Civic Platform server. | [optional] 
**Inheritable** | [**InspectionConditionModelInheritable**](InspectionConditionModelInheritable.md) |  | [optional] 
**InspectionId** | **long?** | The ID of the inspection the condition is attached to. | [optional] 
...
**Priority** | [**InspectionConditionModelPriority**](InspectionConditionModelPriority.md) |  | [optional] 
...
**Severity** | [**InspectionConditionModelSeverity**](InspectionConditionModelSeverity.md) |  | [optional] 
...
**Status** | [**InspectionConditionModelStatus**](InspectionConditionModelStatus.md) |  | [optional] 
