...
namespace AccelaInspections.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InspectionAddressModelCountry :  IEquatable<InspectionAddressModelCountry>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InspectionAddressModelCountry" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public InspectionAddressModelCountry(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InspectionAddressModelCountry {\n");
        ...
        {
            return this.Equals(input as InspectionAddressModelCountry);
        }

        /// <summary>
        /// Returns true if InspectionAddressModelCountry instances are equal
        /// </summary>
        /// <param name="input">Instance of InspectionAddressModelCountry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InspectionAddressModelCountry input)
        {
            if (input == null)
                return false;
