...
namespace AccelaCitizens.Model
{
    ...
    public partial class InlineResponse200 :  IEquatable<InlineResponse200>, IValidatableObject
    {
        ...
        public InlineResponse200(InlineResponse200Result result = default(InlineResponse200Result), int? status = default(int?))
        {
            this.Result = result;
            this.Status = status;
        }
        ...
        public InlineResponse200Result Result { get; set; }
