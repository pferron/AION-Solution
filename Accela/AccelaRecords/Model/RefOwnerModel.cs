...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RefOwnerModel :  IEquatable<RefOwnerModel>, IValidatableObject
    {
        /// <summary>
        ...
        public RefOwnerModel(string email = default(string), string fax = default(string), string firstName = default(string), string fullName = default(string), long? id = default(long?), string isPrimary = default(string), string lastName = default(string), OwnerAddressModel mailAddress = default(OwnerAddressModel), string middleName = default(string), string parcelId = default(string), string phone = default(string), string phoneCountryCode = default(string), RecordIdModel recordId = default(RecordIdModel), double? refOwnerId = default(double?), RefOwnerModelStatus status = default(RefOwnerModelStatus), string taxId = default(string), string title = default(string), string type = default(string))
        {
            this.Email = email;
            this.Fax = fax;
        ...
        public RefOwnerModelStatus Status { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RefOwnerId: ").Append(RefOwnerId).Append("\n");
        ...
        {
            return this.Equals(input as RefOwnerModel);
        }

        /// <summary>
        /// Returns true if RefOwnerModel instances are equal
        /// </summary>
        /// <param name="input">Instance of RefOwnerModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RefOwnerModel input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.RefOwnerId == input.RefOwnerId ||
                    (this.RefOwnerId != null &&
                    this.RefOwnerId.Equals(input.RefOwnerId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RefOwnerId != null)
                    hashCode = hashCode * 59 + this.RefOwnerId.GetHashCode();
                if (this.Status != null)
