...
{
    /// <summary>
    /// CapIDModelV4GetCitizenaccessCitizensIdTrustAccounts
    /// </summary>
    [DataContract]
    public partial class CapIDModelV4GetCitizenaccessCitizensIdTrustAccounts :  IEquatable<CapIDModelV4GetCitizenaccessCitizensIdTrustAccounts>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CapIDModelV4GetCitizenaccessCitizensIdTrustAccounts" /> class.
        /// </summary>
        ...
        public CapIDModelV4GetCitizenaccessCitizensIdTrustAccounts(string customId = default(string), string id = default(string), string serviceProviderCode = default(string), long? trackingId = default(long?), string value = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CapIDModelV4GetCitizenaccessCitizensIdTrustAccounts {\n");
        ...
        {
            return this.Equals(input as CapIDModelV4GetCitizenaccessCitizensIdTrustAccounts);
        }

        /// <summary>
        /// Returns true if CapIDModelV4GetCitizenaccessCitizensIdTrustAccounts instances are equal
        /// </summary>
        /// <param name="input">Instance of CapIDModelV4GetCitizenaccessCitizensIdTrustAccounts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapIDModelV4GetCitizenaccessCitizensIdTrustAccounts input)
        {
            if (input == null)
                return false;
