...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordConditionModelStatus :  IEquatable<RecordConditionModelStatus>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecordConditionModelStatus {\n");
        ...
        {
            return this.Equals(input as RecordConditionModelStatus);
        }

        /// <summary>
        /// Returns true if RecordConditionModelStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordConditionModelStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordConditionModelStatus input)
        {
            if (input == null)
                return false;
