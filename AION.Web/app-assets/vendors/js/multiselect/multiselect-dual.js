...
;(function (factory) {
        ...
        **/
        ...
        Multiselect.prototype = {
            ...
            moveUp: function ($options) {
                ...
                /*Added by EL, not vendor's code*/
                if (typeof $options.first().prev().val() == "undefined") {
                    $('.multiselect-move-up').prop("disabled", true);
                    $('.multiselect-move-down').prop("disabled", false);
                }
                else {
                    if (typeof $options.next().val() != "undefined") {
                        $('.multiselect-move-down').prop("disabled", false);
                    }
                    $('.multiselect-move-up').prop("disabled", false);
                }
            ...
            moveDown: function($options) {
                ...
                if (typeof $options.next().val() == "undefined") {
                    $('.multiselect-move-up').prop("disabled", false);
                    $('.multiselect-move-down').prop("disabled", true);
                }
                else {
                    if (typeof $options.first().prev().val() != "undefined") {
                        $('.multiselect-move-up').prop("disabled", false);
    ...
    $.fn.multiselectDual = function( options ) {
