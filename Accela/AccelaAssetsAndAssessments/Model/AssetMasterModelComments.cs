...
namespace AccelaAssetsAndAssessments.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AssetMasterModelComments :  IEquatable<AssetMasterModelComments>, IValidatableObject
    {
        /// <summary>
        ...
        public AssetMasterModelComments(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssetMasterModelComments {\n");
        ...
        {
            return this.Equals(input as AssetMasterModelComments);
        }

        /// <summary>
        /// Returns true if AssetMasterModelComments instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetMasterModelComments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetMasterModelComments input)
        {
            if (input == null)
                return false;
