...
namespace AccelaCitizens.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PeopleModelSalutation :  IEquatable<PeopleModelSalutation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PeopleModelSalutation" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public PeopleModelSalutation(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PeopleModelSalutation {\n");
        ...
        {
            return this.Equals(input as PeopleModelSalutation);
        }

        /// <summary>
        /// Returns true if PeopleModelSalutation instances are equal
        /// </summary>
        /// <param name="input">Instance of PeopleModelSalutation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PeopleModelSalutation input)
        {
            if (input == null)
                return false;
