...
namespace AccelaCitizens.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResultCountModel :  IEquatable<ResultCountModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResultCountModel" /> class.
        /// </summary>
        /// <param name="failedCount">The number of failed results..</param>
        /// <param name="failedIDs">The IDs of the entities on which the operation failed..</param>
        /// <param name="successCount">The number of successful results..</param>
        /// <param name="successIDs">The IDs of the entities on which the operation succeeded..</param>
        public ResultCountModel(long? failedCount = default(long?), string failedIDs = default(string), long? successCount = default(long?), string successIDs = default(string))
        {
        ...
        /// </summary>
        /// <value>The number of failed results.</value>
        [DataMember(Name="failedCount", EmitDefaultValue=false)]
        public long? FailedCount { get; set; }

        /// <summary>
        /// The IDs of the entities on which the operation failed.
        /// </summary>
        /// <value>The IDs of the entities on which the operation failed.</value>
        ...
        /// </summary>
        /// <value>The number of successful results.</value>
        [DataMember(Name="successCount", EmitDefaultValue=false)]
        public long? SuccessCount { get; set; }

        /// <summary>
        /// The IDs of the entities on which the operation succeeded.
        /// </summary>
        /// <value>The IDs of the entities on which the operation succeeded.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResultCountModel {\n");
        ...
        {
            return this.Equals(input as ResultCountModel);
        }

        /// <summary>
        /// Returns true if ResultCountModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ResultCountModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResultCountModel input)
        {
            if (input == null)
                return false;
