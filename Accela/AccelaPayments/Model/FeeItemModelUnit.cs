...
namespace AccelaPayments.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class FeeItemModelUnit :  IEquatable<FeeItemModelUnit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FeeItemModelUnit" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public FeeItemModelUnit(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FeeItemModelUnit {\n");
        ...
        {
            return this.Equals(input as FeeItemModelUnit);
        }

        /// <summary>
        /// Returns true if FeeItemModelUnit instances are equal
        /// </summary>
        /// <param name="input">Instance of FeeItemModelUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FeeItemModelUnit input)
        {
            if (input == null)
                return false;
