...
namespace AccelaInspections.Model
{
    ...
    public partial class InspectionContactModel :  IEquatable<InspectionContactModel>, IValidatableObject
    {
        ...
        public InspectionContactModel(OwnerAddressModel address = default(OwnerAddressModel), InspectionContactModelBirthCity birthCity = default(InspectionContactModelBirthCity), DateTime? birthDate = default(DateTime?), InspectionContactModelBirthRegion birthRegion = default(InspectionContactModelBirthRegion), InspectionContactModelBirthState birthState = default(InspectionContactModelBirthState), string businessName = default(string), string comment = default(string), DateTime? deceasedDate = default(DateTime?), string driverLicenseNumber = default(string), InspectionContactModelDriverLicenseState driverLicenseState = default(InspectionContactModelDriverLicenseState), string email = default(string), string fax = default(string), string faxCountryCode = default(string), string federalEmployerId = default(string), string firstName = default(string), string fullName = default(string), InspectionContactModelGender gender = default(InspectionContactModelGender), string id = default(string), string individualOrOrganization = default(string), string lastName = default(string), string middleName = default(string), string organizationName = default(string), string passportNumber = default(string), string phone1 = default(string), string phone1CountryCode = default(string), string phone2 = default(string), string phone2CountryCode = default(string), string phone3 = default(string), string phone3CountryCode = default(string), string postOfficeBox = default(string), InspectionContactModelPreferredChannel preferredChannel = default(InspectionContactModelPreferredChannel), InspectionContactModelRace race = default(InspectionContactModelRace), InspectionContactModelRelation relation = default(InspectionContactModelRelation), InspectionContactModelSalutation salutation = default(InspectionContactModelSalutation), string serviceProviderCode = default(string), string socialSecurityNumber = default(string), string stateIdNumber = default(string), InspectionContactModelStatus status = default(InspectionContactModelStatus), string suffix = default(string), string title = default(string), string tradeName = default(string), InspectionContactModelType type = default(InspectionContactModelType))
        {
        ...
        public InspectionContactModelBirthCity BirthCity { get; set; }
        ...
        public InspectionContactModelBirthRegion BirthRegion { get; set; }

        /// <summary>
        /// Gets or Sets BirthState
        /// </summary>
        [DataMember(Name="birthState", EmitDefaultValue=false)]
        public InspectionContactModelBirthState BirthState { get; set; }
        ...
        public InspectionContactModelDriverLicenseState DriverLicenseState { get; set; }
        ...
        public InspectionContactModelGender Gender { get; set; }
        ...
        public InspectionContactModelPreferredChannel PreferredChannel { get; set; }

        /// <summary>
        /// Gets or Sets Race
        /// </summary>
        [DataMember(Name="race", EmitDefaultValue=false)]
        public InspectionContactModelRace Race { get; set; }

        /// <summary>
        /// Gets or Sets Relation
        /// </summary>
        [DataMember(Name="relation", EmitDefaultValue=false)]
        public InspectionContactModelRelation Relation { get; set; }

        /// <summary>
        /// Gets or Sets Salutation
        /// </summary>
        [DataMember(Name="salutation", EmitDefaultValue=false)]
        public InspectionContactModelSalutation Salutation { get; set; }
        ...
        public InspectionContactModelStatus Status { get; set; }
        ...
        public InspectionContactModelType Type { get; set; }
