...
namespace AccelaContactsAndProfessionals.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactModelSalutation :  IEquatable<ContactModelSalutation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactModelSalutation" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public ContactModelSalutation(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactModelSalutation {\n");
        ...
        {
            return this.Equals(input as ContactModelSalutation);
        }

        /// <summary>
        /// Returns true if ContactModelSalutation instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactModelSalutation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactModelSalutation input)
        {
            if (input == null)
                return false;
