...
namespace AccelaPayments.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TrustAccountRequestModelStatus :  IEquatable<TrustAccountRequestModelStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrustAccountRequestModelStatus" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public TrustAccountRequestModelStatus(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrustAccountRequestModelStatus {\n");
        ...
        {
            return this.Equals(input as TrustAccountRequestModelStatus);
        }

        /// <summary>
        /// Returns true if TrustAccountRequestModelStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of TrustAccountRequestModelStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrustAccountRequestModelStatus input)
        {
            if (input == null)
                return false;
