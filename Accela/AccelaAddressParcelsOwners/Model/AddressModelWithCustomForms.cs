...
namespace AccelaAddressParcelsOwners.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddressModelWithCustomForms :  IEquatable<AddressModelWithCustomForms>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressModelWithCustomForms" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddressModelWithCustomForms {\n");
        ...
        {
            return this.Equals(input as AddressModelWithCustomForms);
        }

        /// <summary>
        /// Returns true if AddressModelWithCustomForms instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressModelWithCustomForms to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressModelWithCustomForms input)
        {
            if (input == null)
                return false;
