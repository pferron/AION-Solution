/***********************************************************************************************************************            
* Object:       usp_select_aion_project_get_list_byprojectids            
* Description:  Retrieves Project list for given parameter(s).            
* Parameters:               
*               @projectIds                                                   varchar(800)           
*            
* Returns:      Recordset.            
* Comments:              
* Version:      1.0            
...
* 06/16/2021    jlindsay     initial              
* 07/08/2021 jlindsay add new field for Accela record id REC_ID_TXT      
* 07/22/2021 jallen add new field for Accela team score TEAM_GRADE_TXT        
...
***********************************************************************************************************************/
ALTER PROCEDURE [AION].[usp_select_aion_project_get_list_byprojectids] @projectIds VARCHAR(800)
AS
BEGIN
	SELECT PROJECT_ID,
		P.PROJECT_NM,
		...
		P.REC_ID_TXT,
		P.TEAM_GRADE_TXT,
		P.PRELIM_PROJECT_SUMMARY_OBJ_DETAILS_TXT,
		P.PRELIM_GEN_INFO_OBJ_DETAILS_TXT,
		P.PRELIM_MEETING_AGENDA_OBJ_DETAILS_TXT,
		P.PRELIM_PROPOSED_WORK_OBJ_DETAILS_TXT,
		P.PRELIM_SYSTEM_INFO_OBJ_DETAILS_TXT,
		P.PRELIM_BIM_PROJECT_DELIVERY_OBJ_DETAILS_TXT,
		P.PRELIM_WORK_TYP_OBJ_DETAILS_TXT,
		P.PRELIM_MEETING_DETAIL_OBJ_DETAILS_TXT,
		P.CANCELLATION_FEE_AMT,
		P.PAID_STATUS_IND,
		P.ESTIMATED_FEE_DESC,
		P.RTAP_AFFORDABLE_UNIT_CHG_DESC,
		P.RTAP_AFFORDABLE_UNITS_REMOVE_DESC,
		P.RTAP_AFFORDABLE_WORKFORCE_UNITS_ADD_DESC,
		P.RTAP_WORKFORCE_ADD_DESC,
		P.RTAP_WORKFORCE_REMOVE_DESC,
		P.PROFESSIONALS_TXT,
		P.ACCT_NUM,
		P.EQUIP_COST_DESC,
		P.PREPAID_FEE_PAYMENT_TYP_DESC,
		P.FIFO_DUE_ACCELA_DT
	FROM PROJECT P
	WHERE PROJECT_ID IN (
			SELECT [value]
