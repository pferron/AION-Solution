...
namespace AccelaAddressParcelsOwners.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResponseOwnerModel :  IEquatable<ResponseOwnerModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseOwnerModel" /> class.
        /// </summary>
        /// <param name="result">result.</param>
        /// <param name="status">The HTTP return status..</param>
        public ResponseOwnerModel(OwnerModel result = default(OwnerModel), int? status = default(int?))
        {
            this.Result = result;
            this.Status = status;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseOwnerModel {\n");
        ...
        {
            return this.Equals(input as ResponseOwnerModel);
        }

        /// <summary>
        /// Returns true if ResponseOwnerModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseOwnerModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseOwnerModel input)
        {
            if (input == null)
                return false;
