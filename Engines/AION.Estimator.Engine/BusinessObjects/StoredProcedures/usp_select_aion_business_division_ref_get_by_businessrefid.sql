/***********************************************************************************************************************
* Object:       usp_select_aion_business_division_ref_get_by_businessrefid
...
* 
***********************************************************************************************************************/
CREATE PROCEDURE AION.[usp_select_aion_business_division_ref_get_by_businessrefid] @identity INT
AS
BEGIN
	...
	WHERE br.BUSINESS_REF_ID = @identity
