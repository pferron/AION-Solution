...
namespace AccelaAddressParcelsOwners.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConditionModelStatus :  IEquatable<ConditionModelStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConditionModelStatus" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public ConditionModelStatus(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConditionModelStatus {\n");
        ...
        {
            return this.Equals(input as ConditionModelStatus);
        }

        /// <summary>
        /// Returns true if ConditionModelStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of ConditionModelStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConditionModelStatus input)
        {
            if (input == null)
                return false;
