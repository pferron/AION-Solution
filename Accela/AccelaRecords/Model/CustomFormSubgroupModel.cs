...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomFormSubgroupModel :  IEquatable<CustomFormSubgroupModel>, IValidatableObject
    {
        /// <summary>
        ...
        public CustomFormSubgroupModel(long? displayOrder = default(long?), List<CustomFormField> fields = default(List<CustomFormField>), string id = default(string), string text = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomFormSubgroupModel {\n");
        ...
        {
            return this.Equals(input as CustomFormSubgroupModel);
        }

        /// <summary>
        /// Returns true if CustomFormSubgroupModel instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomFormSubgroupModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomFormSubgroupModel input)
        {
            if (input == null)
                return false;
