...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RequestActivityUpdateModel :  IEquatable<RequestActivityUpdateModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestActivityUpdateModel" /> class.
        /// </summary>
        ...
        public RequestActivityUpdateModel(ActivityModelActivityStatus activityStatus = default(ActivityModelActivityStatus), ActivityModelAssignedDepartment assignedDepartment = default(ActivityModelAssignedDepartment), ActivityModelAssignedUser assignedUser = default(ActivityModelAssignedUser), string description = default(string), DateTime? dueDate = default(DateTime?), string name = default(string), ActivityModelPriority priority = default(ActivityModelPriority), DateTime? startDate = default(DateTime?), ActivityModelStatus status = default(ActivityModelStatus), ActivityModelType type = default(ActivityModelType))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RequestActivityUpdateModel {\n");
        ...
        {
            return this.Equals(input as RequestActivityUpdateModel);
        }

        /// <summary>
        /// Returns true if RequestActivityUpdateModel instances are equal
        /// </summary>
        /// <param name="input">Instance of RequestActivityUpdateModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequestActivityUpdateModel input)
        {
            if (input == null)
                return false;
