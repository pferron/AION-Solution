...
namespace AccelaMiscellanous.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GroupModel :  IEquatable<GroupModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupModel" /> class.
        /// </summary>
        /// <param name="id">The user group system id assigned by the Civic Platform server..</param>
        /// <param name="moduleName">The module the user group belongs to..</param>
        /// <param name="name">The name of the user group..</param>
        public GroupModel(long? id = default(long?), string moduleName = default(string), string name = default(string))
        {
            this.Id = id;
        ...
        /// <summary>
        /// The user group system id assigned by the Civic Platform server.
        /// </summary>
        /// <value>The user group system id assigned by the Civic Platform server.</value>
        ...
        /// <summary>
        /// Returns true if GroupModel instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupModel to be compared</param>
        /// <returns>Boolean</returns>
