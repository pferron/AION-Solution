...
namespace AccelaAddressParcelsOwners.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OwnerModelWithCustomForms :  IEquatable<OwnerModelWithCustomForms>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OwnerModelWithCustomForms" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OwnerModelWithCustomForms {\n");
        ...
        {
            return this.Equals(input as OwnerModelWithCustomForms);
        }

        /// <summary>
        /// Returns true if OwnerModelWithCustomForms instances are equal
        /// </summary>
        /// <param name="input">Instance of OwnerModelWithCustomForms to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OwnerModelWithCustomForms input)
        {
            if (input == null)
                return false;
