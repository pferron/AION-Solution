...
namespace AccelaPayments.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class FeeItemModelPaymentPeriod :  IEquatable<FeeItemModelPaymentPeriod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FeeItemModelPaymentPeriod" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public FeeItemModelPaymentPeriod(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FeeItemModelPaymentPeriod {\n");
        ...
        {
            return this.Equals(input as FeeItemModelPaymentPeriod);
        }

        /// <summary>
        /// Returns true if FeeItemModelPaymentPeriod instances are equal
        /// </summary>
        /// <param name="input">Instance of FeeItemModelPaymentPeriod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FeeItemModelPaymentPeriod input)
        {
            if (input == null)
                return false;
