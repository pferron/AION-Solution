...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordModel :  IEquatable<RecordModel>, IValidatableObject
    {
        /// <summary>
        ...
        public List<RecordAddressModel> Addresses { get; set; }
        ...
        {
            return this.Equals(input as RecordModel);
        }

        /// <summary>
        /// Returns true if RecordModel instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordModel input)
        {
            if (input == null)
                return false;
