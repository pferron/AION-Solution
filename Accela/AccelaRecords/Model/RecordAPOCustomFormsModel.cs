...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordAPOCustomFormsModel :  IEquatable<RecordAPOCustomFormsModel>, IValidatableObject
    {
        /// <summary>
        ...
        public List<AssetMasterModel> Assets { get; set; }
        ...
        public List<RecordContactSimpleModel> Contact { get; set; }
        ...
        public List<RefOwnerModel> Owner { get; set; }

        /// <summary>
        /// Gets or Sets Parcel
        /// </summary>
        [DataMember(Name="parcel", EmitDefaultValue=false)]
        public List<ParcelModel1> Parcel { get; set; }
        ...
        public List<LicenseProfessionalModel> Professional { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecordAPOCustomFormsModel {\n");
        ...
        {
            return this.Equals(input as RecordAPOCustomFormsModel);
        }

        /// <summary>
        /// Returns true if RecordAPOCustomFormsModel instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordAPOCustomFormsModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordAPOCustomFormsModel input)
        {
            if (input == null)
                return false;
