...
namespace AccelaInspections.Model
{
    ...
    public partial class ChecklistItemStatusModel :  IEquatable<ChecklistItemStatusModel>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="text">The status display label..</param>
        /// <param name="value">The status value..</param>
        public ChecklistItemStatusModel(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        /// </summary>
        /// <value>The status display label.</value>
