...
{
    public static class CancelPrelimMeetingTrigger
    {
        ...
        [FunctionName("CancelPrelimMeetingTrigger")]
        public static void Run([TimerTrigger("0 00 23 * * 1-5")] TimerInfo myTimer, TraceWriter log, ExecutionContext context) //Every Weekday 11PM
        {
            ...
            logmessage = $"Timer trigger function CancelPrelimMeetingTrigger executed at: {DateTime.Now}";
            log.Info(logmessage);
            ...
            try
            {
                if (APIHelper.CancelPrelimMeeting(log) == false)
                {
                    logmessage = "Error occurred during CancelPrelimMeetingTrigger - APIHelper.CancelPrelimMeeting(log) == false.";
            ...
            {
                logmessage = "Error occurred during CancelPrelimMeetingTrigger. Check the logs for more details. ApplicationMessageGuid:" + applicationMessageGuid + ", Message: " + ex.Message + ", StackTrace: " + ex.StackTrace;
