...
namespace AccelaContactsAndProfessionals.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactModelType :  IEquatable<ContactModelType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactModelType" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public ContactModelType(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactModelType {\n");
        ...
        {
            return this.Equals(input as ContactModelType);
        }

        /// <summary>
        /// Returns true if ContactModelType instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactModelType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactModelType input)
        {
            if (input == null)
                return false;
