...
namespace AccelaInspections.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InspectionContactModelType :  IEquatable<InspectionContactModelType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InspectionContactModelType" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public InspectionContactModelType(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InspectionContactModelType {\n");
        ...
        {
            return this.Equals(input as InspectionContactModelType);
        }

        /// <summary>
        /// Returns true if InspectionContactModelType instances are equal
        /// </summary>
        /// <param name="input">Instance of InspectionContactModelType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InspectionContactModelType input)
        {
            if (input == null)
                return false;
