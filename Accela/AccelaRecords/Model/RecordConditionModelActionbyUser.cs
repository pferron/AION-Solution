...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordConditionModelActionbyUser :  IEquatable<RecordConditionModelActionbyUser>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecordConditionModelActionbyUser {\n");
        ...
        {
            return this.Equals(input as RecordConditionModelActionbyUser);
        }

        /// <summary>
        /// Returns true if RecordConditionModelActionbyUser instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordConditionModelActionbyUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordConditionModelActionbyUser input)
        {
            if (input == null)
                return false;
