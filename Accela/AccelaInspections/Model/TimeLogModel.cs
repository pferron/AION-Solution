...
namespace AccelaInspections.Model
{
    ...
    public partial class TimeLogModel :  IEquatable<TimeLogModel>, IValidatableObject
    {
        ...
        public TimeLogModel(BillableEnum? billable = default(BillableEnum?), double? cost = default(double?), string createBy = default(string), DateTime? createDate = default(DateTime?), List<CostingQuantityModel> detailDuration = default(List<CostingQuantityModel>), string duration = default(string), string endTime = default(string), string entity = default(string), string entityId = default(string), string entityType = default(string), TimeLogModelGroup group = default(TimeLogModelGroup), long? id = default(long?), double? percent = default(double?), double? rate = default(double?), RecordIdModel recordId = default(RecordIdModel), string serviceProviderCode = default(string), string startTime = default(string), long? totalMinutes = default(long?), TimeLogModelType type = default(TimeLogModelType), string userId = default(string))
        {
