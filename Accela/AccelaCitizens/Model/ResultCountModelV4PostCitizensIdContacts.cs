...
{
    /// <summary>
    /// ResultCountModelV4PostCitizensIdContacts
    /// </summary>
    [DataContract]
    public partial class ResultCountModelV4PostCitizensIdContacts :  IEquatable<ResultCountModelV4PostCitizensIdContacts>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResultCountModelV4PostCitizensIdContacts" /> class.
        /// </summary>
        ...
        public ResultCountModelV4PostCitizensIdContacts(long? failedCount = default(long?), string failedIDs = default(string), long? successCount = default(long?), string successIDs = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResultCountModelV4PostCitizensIdContacts {\n");
        ...
        {
            return this.Equals(input as ResultCountModelV4PostCitizensIdContacts);
        }

        /// <summary>
        /// Returns true if ResultCountModelV4PostCitizensIdContacts instances are equal
        /// </summary>
        /// <param name="input">Instance of ResultCountModelV4PostCitizensIdContacts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResultCountModelV4PostCitizensIdContacts input)
        {
            if (input == null)
                return false;
