...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ActivityModel :  IEquatable<ActivityModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActivityModel" /> class.
        /// </summary>
        ...
        /// <param name="id">The activity system id assigned by the Civic Platform server..</param>
        /// <param name="name">The activity name..</param>
        /// <param name="priority">priority.</param>
        /// <param name="startDate">The activity start date..</param>
        /// <param name="status">status.</param>
        /// <param name="type">type.</param>
        public ActivityModel(ActivityModelActivityStatus activityStatus = default(ActivityModelActivityStatus), ActivityModelAssignedDepartment assignedDepartment = default(ActivityModelAssignedDepartment), ActivityModelAssignedUser assignedUser = default(ActivityModelAssignedUser), string description = default(string), DateTime? dueDate = default(DateTime?), long? id = default(long?), string name = default(string), ActivityModelPriority priority = default(ActivityModelPriority), DateTime? startDate = default(DateTime?), ActivityModelStatus status = default(ActivityModelStatus), ActivityModelType type = default(ActivityModelType))
        {
        ...
        /// </summary>
        /// <value>The activity system id assigned by the Civic Platform server.</value>
        ...
        public ActivityModelStatus Status { get; set; }
        ...
        {
            return this.Equals(input as ActivityModel);
        }

        /// <summary>
        /// Returns true if ActivityModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ActivityModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActivityModel input)
        {
            if (input == null)
                return false;
