...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordTypeNoAliasModel :  IEquatable<RecordTypeNoAliasModel>, IValidatableObject
    {
        /// <summary>
        ...
        public RecordTypeNoAliasModel(string category = default(string), string filterName = default(string), string group = default(string), string id = default(string), string module = default(string), string subType = default(string), string text = default(string), string type = default(string), string value = default(string))
        {
        ...
        {
            return this.Equals(input as RecordTypeNoAliasModel);
        }

        /// <summary>
        /// Returns true if RecordTypeNoAliasModel instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordTypeNoAliasModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordTypeNoAliasModel input)
        {
            if (input == null)
                return false;
