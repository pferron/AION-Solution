...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordContactSimpleModelType :  IEquatable<RecordContactSimpleModelType>, IValidatableObject
    {
        /// <summary>
        ...
        public RecordContactSimpleModelType(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as RecordContactSimpleModelType);
        }

        /// <summary>
        /// Returns true if RecordContactSimpleModelType instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordContactSimpleModelType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordContactSimpleModelType input)
        {
            if (input == null)
                return false;
