# AccelaContactsAndProfessionals.Model.ContactModel
## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Address** | [**CompactAddressModel**](CompactAddressModel.md) |  | [optional] 
**BirthCity** | [**ContactModelBirthCity**](ContactModelBirthCity.md) |  | [optional] 
**BirthDate** | **DateTime?** | The birth date. | [optional] 
**BirthRegion** | [**ContactModelBirthRegion**](ContactModelBirthRegion.md) |  | [optional] 
**BirthState** | [**ContactModelBirthState**](ContactModelBirthState.md) |  | [optional] 
...
**DriverLicenseState** | [**ContactModelDriverLicenseState**](ContactModelDriverLicenseState.md) |  | [optional] 
...
**PreferredChannel** | [**ContactModelPreferredChannel**](ContactModelPreferredChannel.md) |  | [optional] 
**Race** | [**ContactModelRace**](ContactModelRace.md) |  | [optional] 
**Relation** | [**ContactModelRelation**](ContactModelRelation.md) |  | [optional] 
...
**Status** | [**ContactModelStatus**](ContactModelStatus.md) |  | [optional] 
...
**Type** | [**ContactModelType**](ContactModelType.md) |  | [optional] 
