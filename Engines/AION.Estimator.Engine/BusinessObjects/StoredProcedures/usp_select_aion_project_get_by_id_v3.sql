...
* 07/19/2021 jallen add new field for Accela review type desc REVIEW_TYP_REF_DESC     
...
***********************************************************************************************************************/
CREATE PROCEDURE [AION].[usp_select_aion_project_get_by_id_v3] @identity INT
AS
BEGIN
	SELECT PROJECT_ID,
		PROJECT_NM,
