...
namespace AccelaCitizens.Model
{
    ...
    public partial class OwnerAddressModel :  IEquatable<OwnerAddressModel>, IValidatableObject
    {
        ...
        public OwnerAddressModel(string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string city = default(string), CompactAddressModelRequestV4PostCitizenaccessRegisterCountry country = default(CompactAddressModelRequestV4PostCitizenaccessRegisterCountry), string postalCode = default(string), CompactAddressModelRequestV4PostCitizenaccessRegisterCountry state = default(CompactAddressModelRequestV4PostCitizenaccessRegisterCountry))
        {
