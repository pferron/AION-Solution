...
namespace AccelaAssetsAndAssessments.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AssetWithAttributesModel :  IEquatable<AssetWithAttributesModel>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetWithAttributesModel" /> class.
        /// </summary>
        /// <param name="attributeTables">attributeTables.</param>
        ...
        /// <summary>
        /// Gets or Sets AttributeTables
        /// </summary>
        [DataMember(Name="attributeTables", EmitDefaultValue=false)]
        public List<TableModel> AttributeTables { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssetWithAttributesModel {\n");
            sb.Append("  AttributeTables: ").Append(AttributeTables).Append("\n");
        ...
        {
            return this.Equals(input as AssetWithAttributesModel);
        }

        /// <summary>
        /// Returns true if AssetWithAttributesModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetWithAttributesModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetWithAttributesModel input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.AttributeTables == input.AttributeTables ||
                    this.AttributeTables != null &&
                    input.AttributeTables != null &&
                    this.AttributeTables.SequenceEqual(input.AttributeTables)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.AttributeTables != null)
                    hashCode = hashCode * 59 + this.AttributeTables.GetHashCode();
