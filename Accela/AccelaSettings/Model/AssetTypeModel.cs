...
namespace AccelaSettings.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AssetTypeModel :  IEquatable<AssetTypeModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetTypeModel" /> class.
        /// </summary>
        /// <param name="display"> Displays the hierarchical name of the asset type, which includes the asset group and type..</param>
        ...
        public AssetTypeModel(string display = default(string), string gisIDForAssetID = default(string), GISLayerIdModel gisLayer = default(GISLayerIdModel), string gisService = default(string), string group = default(string), string id = default(string), string type = default(string))
        {
        ...
        /// <summary>
        ///  Displays the hierarchical name of the asset type, which includes the asset group and type.
        /// </summary>
        /// <value> Displays the hierarchical name of the asset type, which includes the asset group and type.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssetTypeModel {\n");
        ...
        {
            return this.Equals(input as AssetTypeModel);
        }

        /// <summary>
        /// Returns true if AssetTypeModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetTypeModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetTypeModel input)
        {
            if (input == null)
                return false;
