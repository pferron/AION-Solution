...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordParcelModel :  IEquatable<RecordParcelModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecordParcelModel" /> class.
        /// </summary>
        ...
        public RecordParcelModel(string block = default(string), string book = default(string), string censusTract = default(string), string councilDistrict = default(string), double? exemptionValue = default(double?), long? gisSequenceNumber = default(long?), string id = default(string), double? improvedValue = default(double?), string isPrimary = default(string), double? landValue = default(double?), string legalDescription = default(string), string lot = default(string), string mapNumber = default(string), string mapReferenceInfo = default(string), List<RefOwnerModel> owners = default(List<RefOwnerModel>), string page = default(string), string parcel = default(string), double? parcelArea = default(double?), string parcelNumber = default(string), string planArea = default(string), string range = default(string), RecordIdModel recordId = default(RecordIdModel), long? section = default(long?), RecordParcelModelStatus status = default(RecordParcelModelStatus), RecordParcelModelSubdivision subdivision = default(RecordParcelModelSubdivision), string supervisorDistrict = default(string), string township = default(string), string tract = default(string))
        {
            this.Block = block;
            this.Book = book;
        ...
        public RecordParcelModelStatus Status { get; set; }

        /// <summary>
        /// Gets or Sets Subdivision
        /// </summary>
        [DataMember(Name="subdivision", EmitDefaultValue=false)]
        public RecordParcelModelSubdivision Subdivision { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecordParcelModel {\n");
        ...
        {
            return this.Equals(input as RecordParcelModel);
        }

        /// <summary>
        /// Returns true if RecordParcelModel instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordParcelModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordParcelModel input)
        {
            if (input == null)
                return false;
