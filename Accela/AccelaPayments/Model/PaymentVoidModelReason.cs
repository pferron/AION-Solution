...
{
    /// <summary>
    /// The void payment reason.
    /// </summary>
    [DataContract]
        public partial class PaymentVoidModelReason :  IEquatable<PaymentVoidModelReason>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentVoidModelReason" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public PaymentVoidModelReason(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentVoidModelReason {\n");
        ...
        {
            return this.Equals(input as PaymentVoidModelReason);
        }

        /// <summary>
        /// Returns true if PaymentVoidModelReason instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentVoidModelReason to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentVoidModelReason input)
        {
            if (input == null)
                return false;
