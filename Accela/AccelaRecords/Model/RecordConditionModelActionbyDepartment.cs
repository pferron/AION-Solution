...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordConditionModelActionbyDepartment :  IEquatable<RecordConditionModelActionbyDepartment>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecordConditionModelActionbyDepartment {\n");
        ...
        {
            return this.Equals(input as RecordConditionModelActionbyDepartment);
        }

        /// <summary>
        /// Returns true if RecordConditionModelActionbyDepartment instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordConditionModelActionbyDepartment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordConditionModelActionbyDepartment input)
        {
            if (input == null)
                return false;
