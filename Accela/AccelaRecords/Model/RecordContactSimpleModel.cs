...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordContactSimpleModel :  IEquatable<RecordContactSimpleModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RecordContactSimpleModel);
        }

        /// <summary>
        /// Returns true if RecordContactSimpleModel instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordContactSimpleModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordContactSimpleModel input)
        {
            if (input == null)
                return false;
