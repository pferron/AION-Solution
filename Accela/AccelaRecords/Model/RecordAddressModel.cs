...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordAddressModel :  IEquatable<RecordAddressModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RecordAddressModel);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(RecordAddressModel input)
        {
            if (input == null)
                return false;
