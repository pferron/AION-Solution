...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordConditionModelPriority :  IEquatable<RecordConditionModelPriority>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecordConditionModelPriority {\n");
        ...
        {
            return this.Equals(input as RecordConditionModelPriority);
        }

        /// <summary>
        /// Returns true if RecordConditionModelPriority instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordConditionModelPriority to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordConditionModelPriority input)
        {
            if (input == null)
                return false;
