...
namespace AccelaPayments.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TrustAccountRequestModelOverdraft :  IEquatable<TrustAccountRequestModelOverdraft>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrustAccountRequestModelOverdraft" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public TrustAccountRequestModelOverdraft(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrustAccountRequestModelOverdraft {\n");
        ...
        {
            return this.Equals(input as TrustAccountRequestModelOverdraft);
        }

        /// <summary>
        /// Returns true if TrustAccountRequestModelOverdraft instances are equal
        /// </summary>
        /// <param name="input">Instance of TrustAccountRequestModelOverdraft to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrustAccountRequestModelOverdraft input)
        {
            if (input == null)
                return false;
