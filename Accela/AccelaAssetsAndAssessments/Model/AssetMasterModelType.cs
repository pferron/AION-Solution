...
namespace AccelaAssetsAndAssessments.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AssetMasterModelType :  IEquatable<AssetMasterModelType>, IValidatableObject
    {
        /// <summary>
        ...
        public AssetMasterModelType(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssetMasterModelType {\n");
        ...
        {
            return this.Equals(input as AssetMasterModelType);
        }

        /// <summary>
        /// Returns true if AssetMasterModelType instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetMasterModelType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetMasterModelType input)
        {
            if (input == null)
                return false;
