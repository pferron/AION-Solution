...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordContactSimpleModelSalutation :  IEquatable<RecordContactSimpleModelSalutation>, IValidatableObject
    {
        /// <summary>
        ...
        public RecordContactSimpleModelSalutation(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecordContactSimpleModelSalutation {\n");
        ...
        {
            return this.Equals(input as RecordContactSimpleModelSalutation);
        }

        /// <summary>
        /// Returns true if RecordContactSimpleModelSalutation instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordContactSimpleModelSalutation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordContactSimpleModelSalutation input)
        {
            if (input == null)
                return false;
