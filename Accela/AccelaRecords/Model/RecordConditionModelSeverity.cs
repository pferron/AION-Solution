...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordConditionModelSeverity :  IEquatable<RecordConditionModelSeverity>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecordConditionModelSeverity {\n");
        ...
        {
            return this.Equals(input as RecordConditionModelSeverity);
        }

        /// <summary>
        /// Returns true if RecordConditionModelSeverity instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordConditionModelSeverity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordConditionModelSeverity input)
        {
            if (input == null)
                return false;
