...
namespace AccelaAssetsAndAssessments.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AssetExtModel :  IEquatable<AssetExtModel>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetExtModel" /> class.
        /// </summary>
        ...
        public AssetExtModel(string assetId = default(string), string classType = default(string), AssetMasterModelComments comments = default(AssetMasterModelComments), double? currentValue = default(double?), DateTime? dateOfService = default(DateTime?), DependentFlagEnum? dependentFlag = default(DependentFlagEnum?), double? depreciationAmount = default(double?), DateTime? depreciationEndDate = default(DateTime?), DateTime? depreciationStartDate = default(DateTime?), double? depreciationValue = default(double?), AssetMasterModelDescription description = default(AssetMasterModelDescription), string endID = default(string), List<GISObjectModel> gisObjects = default(List<GISObjectModel>), long? id = default(long?), AssetMasterModelName name = default(AssetMasterModelName), string number = default(string), List<SimpleRecordModel> records = default(List<SimpleRecordModel>), double? salvageValue = default(double?), string serviceProviderCode = default(string), double? size = default(double?), string sizeUnit = default(string), string startID = default(string), double? startValue = default(double?), AssetMasterModelStatus status = default(AssetMasterModelStatus), DateTime? statusDate = default(DateTime?), AssetMasterModelType type = default(AssetMasterModelType))
        {
        ...
        {
            return this.Equals(input as AssetExtModel);
        }

        /// <summary>
        /// Returns true if AssetExtModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetExtModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetExtModel input)
        {
            if (input == null)
                return false;
