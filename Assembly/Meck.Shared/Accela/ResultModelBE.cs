...
{
    public partial class ResultModelBE  
    {
        /// <summary>
        ...
        public ResultModelBE(string code = default(string), long? id = default(long?), bool? isSuccess = default(bool?), string message = default(string))
        {
            this.Code = code;
            this.Id = id;
        ...
        {
            return this.Equals(input as ResultModelBE);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ResultModelBE input)
        {
            if (input == null)
                return false;
