...
namespace AccelaContactsAndProfessionals.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactModelRace :  IEquatable<ContactModelRace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactModelRace" /> class.
        /// </summary>
        /// <param name="text">The localized display value..</param>
        /// <param name="value">The data value..</param>
        public ContactModelRace(string text = default(string), string value = default(string))
        {
            this.Text = text;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactModelRace {\n");
        ...
        {
            return this.Equals(input as ContactModelRace);
        }

        /// <summary>
        /// Returns true if ContactModelRace instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactModelRace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactModelRace input)
        {
            if (input == null)
                return false;
