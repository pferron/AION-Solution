...
{
    /// <summary>
    /// ResponseOwnerModelArray
    /// </summary>
    [DataContract]
    public partial class ResponseOwnerModelArray :  IEquatable<ResponseOwnerModelArray>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseOwnerModelArray" /> class.
        /// </summary>
        /// <param name="result">result.</param>
        /// <param name="page">page.</param>
        /// <param name="status">The HTTP return status..</param>
        public ResponseOwnerModelArray(List<OwnerModel> result = default(List<OwnerModel>), PageModel page = default(PageModel), int? status = default(int?))
        {
            this.Result = result;
            this.Page = page;
            this.Status = status;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseOwnerModelArray {\n");
        ...
        {
            return this.Equals(input as ResponseOwnerModelArray);
        }

        /// <summary>
        /// Returns true if ResponseOwnerModelArray instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseOwnerModelArray to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseOwnerModelArray input)
        {
            if (input == null)
                return false;
