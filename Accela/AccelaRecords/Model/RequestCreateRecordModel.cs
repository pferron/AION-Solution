...
namespace AccelaRecords.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RequestCreateRecordModel :  IEquatable<RequestCreateRecordModel>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestCreateRecordModel" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RequestCreateRecordModel {\n");
        ...
        {
            return this.Equals(input as RequestCreateRecordModel);
        }

        /// <summary>
        /// Returns true if RequestCreateRecordModel instances are equal
        /// </summary>
        /// <param name="input">Instance of RequestCreateRecordModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequestCreateRecordModel input)
        {
            if (input == null)
                return false;
